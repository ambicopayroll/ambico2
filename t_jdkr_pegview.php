...
$t_jdkr_peg_view = NULL; // Initialize page object first

class ct_jdkr_peg_view extends ct_jdkr_peg {
	...
	// Page object name
	var $PageObjName = 't_jdkr_peg_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["jdkr_id"] <> "") {
			$this->RecKey["jdkr_id"] = $_GET["jdkr_id"];
			$KeyUrl .= "&amp;jdkr_id=" . urlencode($this->RecKey["jdkr_id"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["jdkr_id"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["jdkr_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			} elseif (@$_POST["jdkr_id"] <> "") {
				$this->jdkr_id->setFormValue($_POST["jdkr_id"]);
				$this->RecKey["jdkr_id"] = $this->jdkr_id->FormValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t_jdkr_peglist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "t_jdkr_peglist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t_jdkr_peg_view)) $t_jdkr_peg_view = new ct_jdkr_peg_view();

// Page init
$t_jdkr_peg_view->Page_Init();

// Page main
$t_jdkr_peg_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_jdkr_peg_view->Page_Render();
?>
...
var CurrentForm = ft_jdkr_pegview = new ew_Form("ft_jdkr_pegview", "view");

// Form_CustomValidate event
ft_jdkr_pegview.Form_CustomValidate = 
...
ft_jdkr_pegview.ValidateRequired = true;
<?php } else { ?>
ft_jdkr_pegview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($t_jdkr_peg->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t_jdkr_peg_view->IsModal) { ?>
<?php if ($t_jdkr_peg->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $t_jdkr_peg_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t_jdkr_peg_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t_jdkr_peg_view->IsModal) { ?>
<?php if ($t_jdkr_peg->Export == "") { ?>
...
<?php } ?>
<?php $t_jdkr_peg_view->ShowPageHeader(); ?>
<?php
$t_jdkr_peg_view->ShowMessage();
?>
<?php if (!$t_jdkr_peg_view->IsModal) { ?>
<?php if ($t_jdkr_peg->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t_jdkr_peg_view->Pager)) $t_jdkr_peg_view->Pager = new cPrevNextPager($t_jdkr_peg_view->StartRec, $t_jdkr_peg_view->DisplayRecs, $t_jdkr_peg_view->TotalRecs) ?>
<?php if ($t_jdkr_peg_view->Pager->RecordCount > 0 && $t_jdkr_peg_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t_jdkr_peg_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t_jdkr_peg_view->PageUrl() ?>start=<?php echo $t_jdkr_peg_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t_jdkr_peg_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t_jdkr_peg_view->PageUrl() ?>start=<?php echo $t_jdkr_peg_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t_jdkr_peg_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t_jdkr_peg_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t_jdkr_peg_view->PageUrl() ?>start=<?php echo $t_jdkr_peg_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t_jdkr_peg_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t_jdkr_peg_view->PageUrl() ?>start=<?php echo $t_jdkr_peg_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t_jdkr_peg_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="ft_jdkr_pegview" id="ft_jdkr_pegview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_jdkr_peg_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_jdkr_peg_view->Token ?>">
<?php } ?>
...
<?php if ($t_jdkr_peg->jdkr_id->Visible) { // jdkr_id ?>
	<tr id="r_jdkr_id">
		<td><span id="elh_t_jdkr_peg_jdkr_id"><?php echo $t_jdkr_peg->jdkr_id->FldCaption() ?></span></td>
...
<?php echo $t_jdkr_peg->jdkr_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jdkr_peg->pegawai_id->Visible) { // pegawai_id ?>
	<tr id="r_pegawai_id">
		<td><span id="elh_t_jdkr_peg_pegawai_id"><?php echo $t_jdkr_peg->pegawai_id->FldCaption() ?></span></td>
...
<?php echo $t_jdkr_peg->pegawai_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($t_jdkr_peg->jk_id->Visible) { // jk_id ?>
	<tr id="r_jk_id">
		<td><span id="elh_t_jdkr_peg_jk_id"><?php echo $t_jdkr_peg->jk_id->FldCaption() ?></span></td>
...
<?php echo $t_jdkr_peg->jk_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($t_jdkr_peg->Export == "") { ?>
<script type="text/javascript">
ft_jdkr_pegview.Init();
</script>
<?php } ?>
<?php
$t_jdkr_peg_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($t_jdkr_peg->Export == "") { ?>
...
<?php
$t_jdkr_peg_view->Page_Terminate();
?>
