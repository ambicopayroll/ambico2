...
$rekon_php = NULL; // Initialize page object first
...
class crekon_php {
	...
	// Table name
	var $TableName = 'rekon.php';

	// Page object name
	var $PageObjName = 'rekon_php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'rekon.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "rekon_php", $url, "", "rekon_php", TRUE);
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($rekon_php)) $rekon_php = new crekon_php();
...
<?php } ?>
<form id="myform" name="myform" class="form-horizontal" method="post" action="proses.php">
