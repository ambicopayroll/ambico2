...
//
class cratt_log extends crTableBase {
	...
	function __construct() {
		...
		// sn
		$this->sn = new crField('att_log', 'att_log', 'x_sn', 'sn', '`sn`', 200, EWR_DATATYPE_STRING, -1);
		...
		// scan_date
		$this->scan_date = new crField('att_log', 'att_log', 'x_scan_date', 'scan_date', '`scan_date`', 135, EWR_DATATYPE_DATE, 0);
		...
		// pin
		$this->pin = new crField('att_log', 'att_log', 'x_pin', 'pin', '`pin`', 200, EWR_DATATYPE_STRING, -1);
		...
		// verifymode
		$this->verifymode = new crField('att_log', 'att_log', 'x_verifymode', 'verifymode', '`verifymode`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// inoutmode
		$this->inoutmode = new crField('att_log', 'att_log', 'x_inoutmode', 'inoutmode', '`inoutmode`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// reserved
		$this->reserved = new crField('att_log', 'att_log', 'x_reserved', 'reserved', '`reserved`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// work_code
		$this->work_code = new crField('att_log', 'att_log', 'x_work_code', 'work_code', '`work_code`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// att_id
		$this->att_id = new crField('att_log', 'att_log', 'x_att_id', 'att_id', '`att_id`', 200, EWR_DATATYPE_STRING, -1);
