...
$coba_php = NULL; // Initialize page object first
...
class ccoba_php {
	...
	// Table name
	var $TableName = 'coba.php';

	// Page object name
	var $PageObjName = 'coba_php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'coba.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "coba_php", $url, "", "coba_php", TRUE);
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($coba_php)) $coba_php = new ccoba_php();
