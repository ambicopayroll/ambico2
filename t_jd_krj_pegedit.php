...
$t_jd_krj_peg_edit = NULL; // Initialize page object first

class ct_jd_krj_peg_edit extends ct_jd_krj_peg {
	...
	// Page object name
	var $PageObjName = 't_jd_krj_peg_edit';
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->jdwkrjpeg_id->FldIsDetailKey)
			$this->jdwkrjpeg_id->setFormValue($objForm->GetValue("x_jdwkrjpeg_id"));
	...
	function RestoreFormValues() {
		global $objForm;
		$this->LoadRow();
		$this->jdwkrjpeg_id->CurrentValue = $this->jdwkrjpeg_id->FormValue;
	...
	function EditRow() {
		...
		if ($this->pegawai_id->CurrentValue <> "") { // Check field with unique index
			$sFilterChk = "(`pegawai_id` = " . ew_AdjustSql($this->pegawai_id->CurrentValue, $this->DBID) . ")";
		...
		if ($rs->EOF) {
			...
			// f20170101
			$this->f20170101->SetDbValueDef($rsnew, $this->f20170101->CurrentValue, NULL, $this->f20170101->ReadOnly);

			// f20170102
			$this->f20170102->SetDbValueDef($rsnew, $this->f20170102->CurrentValue, NULL, $this->f20170102->ReadOnly);

			// f20170103
			$this->f20170103->SetDbValueDef($rsnew, $this->f20170103->CurrentValue, NULL, $this->f20170103->ReadOnly);

			// f20170104
			$this->f20170104->SetDbValueDef($rsnew, $this->f20170104->CurrentValue, NULL, $this->f20170104->ReadOnly);

			// f20170105
			$this->f20170105->SetDbValueDef($rsnew, $this->f20170105->CurrentValue, NULL, $this->f20170105->ReadOnly);

			// f20170106
			$this->f20170106->SetDbValueDef($rsnew, $this->f20170106->CurrentValue, NULL, $this->f20170106->ReadOnly);

			// f20170107
			$this->f20170107->SetDbValueDef($rsnew, $this->f20170107->CurrentValue, NULL, $this->f20170107->ReadOnly);

			// f20170108
			$this->f20170108->SetDbValueDef($rsnew, $this->f20170108->CurrentValue, NULL, $this->f20170108->ReadOnly);

			// f20170109
			$this->f20170109->SetDbValueDef($rsnew, $this->f20170109->CurrentValue, NULL, $this->f20170109->ReadOnly);

			// f20170110
			$this->f20170110->SetDbValueDef($rsnew, $this->f20170110->CurrentValue, NULL, $this->f20170110->ReadOnly);

			// f20170111
			$this->f20170111->SetDbValueDef($rsnew, $this->f20170111->CurrentValue, NULL, $this->f20170111->ReadOnly);

			// f20170112
			$this->f20170112->SetDbValueDef($rsnew, $this->f20170112->CurrentValue, NULL, $this->f20170112->ReadOnly);

			// f20170113
			$this->f20170113->SetDbValueDef($rsnew, $this->f20170113->CurrentValue, NULL, $this->f20170113->ReadOnly);

			// f20170114
			$this->f20170114->SetDbValueDef($rsnew, $this->f20170114->CurrentValue, NULL, $this->f20170114->ReadOnly);

			// f20170115
			$this->f20170115->SetDbValueDef($rsnew, $this->f20170115->CurrentValue, NULL, $this->f20170115->ReadOnly);

			// f20170116
			$this->f20170116->SetDbValueDef($rsnew, $this->f20170116->CurrentValue, NULL, $this->f20170116->ReadOnly);

			// f20170117
			$this->f20170117->SetDbValueDef($rsnew, $this->f20170117->CurrentValue, NULL, $this->f20170117->ReadOnly);

			// f20170118
			$this->f20170118->SetDbValueDef($rsnew, $this->f20170118->CurrentValue, NULL, $this->f20170118->ReadOnly);

			// f20170119
			$this->f20170119->SetDbValueDef($rsnew, $this->f20170119->CurrentValue, NULL, $this->f20170119->ReadOnly);

			// f20170120
			$this->f20170120->SetDbValueDef($rsnew, $this->f20170120->CurrentValue, NULL, $this->f20170120->ReadOnly);

			// f20170121
			$this->f20170121->SetDbValueDef($rsnew, $this->f20170121->CurrentValue, NULL, $this->f20170121->ReadOnly);

			// f20170122
			$this->f20170122->SetDbValueDef($rsnew, $this->f20170122->CurrentValue, NULL, $this->f20170122->ReadOnly);

			// f20170123
			$this->f20170123->SetDbValueDef($rsnew, $this->f20170123->CurrentValue, NULL, $this->f20170123->ReadOnly);

			// f20170124
			$this->f20170124->SetDbValueDef($rsnew, $this->f20170124->CurrentValue, NULL, $this->f20170124->ReadOnly);

			// f20170125
			$this->f20170125->SetDbValueDef($rsnew, $this->f20170125->CurrentValue, NULL, $this->f20170125->ReadOnly);

			// f20170126
			$this->f20170126->SetDbValueDef($rsnew, $this->f20170126->CurrentValue, NULL, $this->f20170126->ReadOnly);

			// f20170127
			$this->f20170127->SetDbValueDef($rsnew, $this->f20170127->CurrentValue, NULL, $this->f20170127->ReadOnly);

			// f20170128
			$this->f20170128->SetDbValueDef($rsnew, $this->f20170128->CurrentValue, NULL, $this->f20170128->ReadOnly);

			// f20170129
			$this->f20170129->SetDbValueDef($rsnew, $this->f20170129->CurrentValue, NULL, $this->f20170129->ReadOnly);

			// f20170130
			$this->f20170130->SetDbValueDef($rsnew, $this->f20170130->CurrentValue, NULL, $this->f20170130->ReadOnly);

			// f20170131
			$this->f20170131->SetDbValueDef($rsnew, $this->f20170131->CurrentValue, NULL, $this->f20170131->ReadOnly);

			// f20170201
			$this->f20170201->SetDbValueDef($rsnew, $this->f20170201->CurrentValue, NULL, $this->f20170201->ReadOnly);

			// f20170202
			$this->f20170202->SetDbValueDef($rsnew, $this->f20170202->CurrentValue, NULL, $this->f20170202->ReadOnly);

			// f20170203
			$this->f20170203->SetDbValueDef($rsnew, $this->f20170203->CurrentValue, NULL, $this->f20170203->ReadOnly);

			// f20170204
			$this->f20170204->SetDbValueDef($rsnew, $this->f20170204->CurrentValue, NULL, $this->f20170204->ReadOnly);

			// f20170205
			$this->f20170205->SetDbValueDef($rsnew, $this->f20170205->CurrentValue, NULL, $this->f20170205->ReadOnly);

			// f20170206
			$this->f20170206->SetDbValueDef($rsnew, $this->f20170206->CurrentValue, NULL, $this->f20170206->ReadOnly);

			// f20170207
			$this->f20170207->SetDbValueDef($rsnew, $this->f20170207->CurrentValue, NULL, $this->f20170207->ReadOnly);

			// f20170208
			$this->f20170208->SetDbValueDef($rsnew, $this->f20170208->CurrentValue, NULL, $this->f20170208->ReadOnly);

			// f20170209
			$this->f20170209->SetDbValueDef($rsnew, $this->f20170209->CurrentValue, NULL, $this->f20170209->ReadOnly);

			// f20170210
			$this->f20170210->SetDbValueDef($rsnew, $this->f20170210->CurrentValue, NULL, $this->f20170210->ReadOnly);

			// f20170211
			$this->f20170211->SetDbValueDef($rsnew, $this->f20170211->CurrentValue, NULL, $this->f20170211->ReadOnly);

			// f20170212
			$this->f20170212->SetDbValueDef($rsnew, $this->f20170212->CurrentValue, NULL, $this->f20170212->ReadOnly);

			// f20170213
			$this->f20170213->SetDbValueDef($rsnew, $this->f20170213->CurrentValue, NULL, $this->f20170213->ReadOnly);

			// f20170214
			$this->f20170214->SetDbValueDef($rsnew, $this->f20170214->CurrentValue, NULL, $this->f20170214->ReadOnly);

			// f20170215
			$this->f20170215->SetDbValueDef($rsnew, $this->f20170215->CurrentValue, NULL, $this->f20170215->ReadOnly);

			// f20170216
			$this->f20170216->SetDbValueDef($rsnew, $this->f20170216->CurrentValue, NULL, $this->f20170216->ReadOnly);

			// f20170217
			$this->f20170217->SetDbValueDef($rsnew, $this->f20170217->CurrentValue, NULL, $this->f20170217->ReadOnly);

			// f20170218
			$this->f20170218->SetDbValueDef($rsnew, $this->f20170218->CurrentValue, NULL, $this->f20170218->ReadOnly);

			// f20170219
			$this->f20170219->SetDbValueDef($rsnew, $this->f20170219->CurrentValue, NULL, $this->f20170219->ReadOnly);

			// f20170220
			$this->f20170220->SetDbValueDef($rsnew, $this->f20170220->CurrentValue, NULL, $this->f20170220->ReadOnly);

			// f20170221
			$this->f20170221->SetDbValueDef($rsnew, $this->f20170221->CurrentValue, NULL, $this->f20170221->ReadOnly);

			// f20170222
			$this->f20170222->SetDbValueDef($rsnew, $this->f20170222->CurrentValue, NULL, $this->f20170222->ReadOnly);

			// f20170223
			$this->f20170223->SetDbValueDef($rsnew, $this->f20170223->CurrentValue, NULL, $this->f20170223->ReadOnly);

			// f20170224
			$this->f20170224->SetDbValueDef($rsnew, $this->f20170224->CurrentValue, NULL, $this->f20170224->ReadOnly);

			// f20170225
			$this->f20170225->SetDbValueDef($rsnew, $this->f20170225->CurrentValue, NULL, $this->f20170225->ReadOnly);

			// f20170226
			$this->f20170226->SetDbValueDef($rsnew, $this->f20170226->CurrentValue, NULL, $this->f20170226->ReadOnly);

			// f20170227
			$this->f20170227->SetDbValueDef($rsnew, $this->f20170227->CurrentValue, NULL, $this->f20170227->ReadOnly);

			// f20170228
			$this->f20170228->SetDbValueDef($rsnew, $this->f20170228->CurrentValue, NULL, $this->f20170228->ReadOnly);

			// f20170229
			$this->f20170229->SetDbValueDef($rsnew, $this->f20170229->CurrentValue, NULL, $this->f20170229->ReadOnly);

			// f20170301
			$this->f20170301->SetDbValueDef($rsnew, $this->f20170301->CurrentValue, NULL, $this->f20170301->ReadOnly);

			// f20170302
			$this->f20170302->SetDbValueDef($rsnew, $this->f20170302->CurrentValue, NULL, $this->f20170302->ReadOnly);

			// f20170303
			$this->f20170303->SetDbValueDef($rsnew, $this->f20170303->CurrentValue, NULL, $this->f20170303->ReadOnly);

			// f20170304
			$this->f20170304->SetDbValueDef($rsnew, $this->f20170304->CurrentValue, NULL, $this->f20170304->ReadOnly);

			// f20170305
			$this->f20170305->SetDbValueDef($rsnew, $this->f20170305->CurrentValue, NULL, $this->f20170305->ReadOnly);

			// f20170306
			$this->f20170306->SetDbValueDef($rsnew, $this->f20170306->CurrentValue, NULL, $this->f20170306->ReadOnly);

			// f20170307
			$this->f20170307->SetDbValueDef($rsnew, $this->f20170307->CurrentValue, NULL, $this->f20170307->ReadOnly);

			// f20170308
			$this->f20170308->SetDbValueDef($rsnew, $this->f20170308->CurrentValue, NULL, $this->f20170308->ReadOnly);

			// f20170309
			$this->f20170309->SetDbValueDef($rsnew, $this->f20170309->CurrentValue, NULL, $this->f20170309->ReadOnly);

			// f20170310
			$this->f20170310->SetDbValueDef($rsnew, $this->f20170310->CurrentValue, NULL, $this->f20170310->ReadOnly);

			// f20170311
			$this->f20170311->SetDbValueDef($rsnew, $this->f20170311->CurrentValue, NULL, $this->f20170311->ReadOnly);

			// f20170312
			$this->f20170312->SetDbValueDef($rsnew, $this->f20170312->CurrentValue, NULL, $this->f20170312->ReadOnly);

			// f20170313
			$this->f20170313->SetDbValueDef($rsnew, $this->f20170313->CurrentValue, NULL, $this->f20170313->ReadOnly);

			// f20170314
			$this->f20170314->SetDbValueDef($rsnew, $this->f20170314->CurrentValue, NULL, $this->f20170314->ReadOnly);

			// f20170315
			$this->f20170315->SetDbValueDef($rsnew, $this->f20170315->CurrentValue, NULL, $this->f20170315->ReadOnly);

			// f20170316
			$this->f20170316->SetDbValueDef($rsnew, $this->f20170316->CurrentValue, NULL, $this->f20170316->ReadOnly);

			// f20170317
			$this->f20170317->SetDbValueDef($rsnew, $this->f20170317->CurrentValue, NULL, $this->f20170317->ReadOnly);

			// f20170318
			$this->f20170318->SetDbValueDef($rsnew, $this->f20170318->CurrentValue, NULL, $this->f20170318->ReadOnly);

			// f20170319
			$this->f20170319->SetDbValueDef($rsnew, $this->f20170319->CurrentValue, NULL, $this->f20170319->ReadOnly);

			// f20170320
			$this->f20170320->SetDbValueDef($rsnew, $this->f20170320->CurrentValue, NULL, $this->f20170320->ReadOnly);

			// f20170321
			$this->f20170321->SetDbValueDef($rsnew, $this->f20170321->CurrentValue, NULL, $this->f20170321->ReadOnly);

			// f20170322
			$this->f20170322->SetDbValueDef($rsnew, $this->f20170322->CurrentValue, NULL, $this->f20170322->ReadOnly);

			// f20170323
			$this->f20170323->SetDbValueDef($rsnew, $this->f20170323->CurrentValue, NULL, $this->f20170323->ReadOnly);

			// f20170324
			$this->f20170324->SetDbValueDef($rsnew, $this->f20170324->CurrentValue, NULL, $this->f20170324->ReadOnly);

			// f20170325
			$this->f20170325->SetDbValueDef($rsnew, $this->f20170325->CurrentValue, NULL, $this->f20170325->ReadOnly);

			// f20170326
			$this->f20170326->SetDbValueDef($rsnew, $this->f20170326->CurrentValue, NULL, $this->f20170326->ReadOnly);

			// f20170327
			$this->f20170327->SetDbValueDef($rsnew, $this->f20170327->CurrentValue, NULL, $this->f20170327->ReadOnly);

			// f20170328
			$this->f20170328->SetDbValueDef($rsnew, $this->f20170328->CurrentValue, NULL, $this->f20170328->ReadOnly);

			// f20170329
			$this->f20170329->SetDbValueDef($rsnew, $this->f20170329->CurrentValue, NULL, $this->f20170329->ReadOnly);

			// f20170330
			$this->f20170330->SetDbValueDef($rsnew, $this->f20170330->CurrentValue, NULL, $this->f20170330->ReadOnly);

			// f20170331
			$this->f20170331->SetDbValueDef($rsnew, $this->f20170331->CurrentValue, NULL, $this->f20170331->ReadOnly);

			// f20170401
			$this->f20170401->SetDbValueDef($rsnew, $this->f20170401->CurrentValue, NULL, $this->f20170401->ReadOnly);

			// f20170402
			$this->f20170402->SetDbValueDef($rsnew, $this->f20170402->CurrentValue, NULL, $this->f20170402->ReadOnly);

			// f20170403
			$this->f20170403->SetDbValueDef($rsnew, $this->f20170403->CurrentValue, NULL, $this->f20170403->ReadOnly);

			// f20170404
			$this->f20170404->SetDbValueDef($rsnew, $this->f20170404->CurrentValue, NULL, $this->f20170404->ReadOnly);

			// f20170405
			$this->f20170405->SetDbValueDef($rsnew, $this->f20170405->CurrentValue, NULL, $this->f20170405->ReadOnly);

			// f20170406
			$this->f20170406->SetDbValueDef($rsnew, $this->f20170406->CurrentValue, NULL, $this->f20170406->ReadOnly);

			// f20170407
			$this->f20170407->SetDbValueDef($rsnew, $this->f20170407->CurrentValue, NULL, $this->f20170407->ReadOnly);

			// f20170408
			$this->f20170408->SetDbValueDef($rsnew, $this->f20170408->CurrentValue, NULL, $this->f20170408->ReadOnly);

			// f20170409
			$this->f20170409->SetDbValueDef($rsnew, $this->f20170409->CurrentValue, NULL, $this->f20170409->ReadOnly);

			// f20170410
			$this->f20170410->SetDbValueDef($rsnew, $this->f20170410->CurrentValue, NULL, $this->f20170410->ReadOnly);

			// f20170411
			$this->f20170411->SetDbValueDef($rsnew, $this->f20170411->CurrentValue, NULL, $this->f20170411->ReadOnly);

			// f20170412
			$this->f20170412->SetDbValueDef($rsnew, $this->f20170412->CurrentValue, NULL, $this->f20170412->ReadOnly);

			// f20170413
			$this->f20170413->SetDbValueDef($rsnew, $this->f20170413->CurrentValue, NULL, $this->f20170413->ReadOnly);

			// f20170414
			$this->f20170414->SetDbValueDef($rsnew, $this->f20170414->CurrentValue, NULL, $this->f20170414->ReadOnly);

			// f20170415
			$this->f20170415->SetDbValueDef($rsnew, $this->f20170415->CurrentValue, NULL, $this->f20170415->ReadOnly);

			// f20170416
			$this->f20170416->SetDbValueDef($rsnew, $this->f20170416->CurrentValue, NULL, $this->f20170416->ReadOnly);

			// f20170417
			$this->f20170417->SetDbValueDef($rsnew, $this->f20170417->CurrentValue, NULL, $this->f20170417->ReadOnly);

			// f20170418
			$this->f20170418->SetDbValueDef($rsnew, $this->f20170418->CurrentValue, NULL, $this->f20170418->ReadOnly);

			// f20170419
			$this->f20170419->SetDbValueDef($rsnew, $this->f20170419->CurrentValue, NULL, $this->f20170419->ReadOnly);

			// f20170420
			$this->f20170420->SetDbValueDef($rsnew, $this->f20170420->CurrentValue, NULL, $this->f20170420->ReadOnly);

			// f20170421
			$this->f20170421->SetDbValueDef($rsnew, $this->f20170421->CurrentValue, NULL, $this->f20170421->ReadOnly);

			// f20170422
			$this->f20170422->SetDbValueDef($rsnew, $this->f20170422->CurrentValue, NULL, $this->f20170422->ReadOnly);

			// f20170423
			$this->f20170423->SetDbValueDef($rsnew, $this->f20170423->CurrentValue, NULL, $this->f20170423->ReadOnly);

			// f20170424
			$this->f20170424->SetDbValueDef($rsnew, $this->f20170424->CurrentValue, NULL, $this->f20170424->ReadOnly);

			// f20170425
			$this->f20170425->SetDbValueDef($rsnew, $this->f20170425->CurrentValue, NULL, $this->f20170425->ReadOnly);

			// f20170426
			$this->f20170426->SetDbValueDef($rsnew, $this->f20170426->CurrentValue, NULL, $this->f20170426->ReadOnly);

			// f20170427
			$this->f20170427->SetDbValueDef($rsnew, $this->f20170427->CurrentValue, NULL, $this->f20170427->ReadOnly);

			// f20170428
			$this->f20170428->SetDbValueDef($rsnew, $this->f20170428->CurrentValue, NULL, $this->f20170428->ReadOnly);

			// f20170429
			$this->f20170429->SetDbValueDef($rsnew, $this->f20170429->CurrentValue, NULL, $this->f20170429->ReadOnly);

			// f20170430
			$this->f20170430->SetDbValueDef($rsnew, $this->f20170430->CurrentValue, NULL, $this->f20170430->ReadOnly);

			// f20170501
			$this->f20170501->SetDbValueDef($rsnew, $this->f20170501->CurrentValue, NULL, $this->f20170501->ReadOnly);

			// f20170502
			$this->f20170502->SetDbValueDef($rsnew, $this->f20170502->CurrentValue, NULL, $this->f20170502->ReadOnly);

			// f20170503
			$this->f20170503->SetDbValueDef($rsnew, $this->f20170503->CurrentValue, NULL, $this->f20170503->ReadOnly);

			// f20170504
			$this->f20170504->SetDbValueDef($rsnew, $this->f20170504->CurrentValue, NULL, $this->f20170504->ReadOnly);

			// f20170505
			$this->f20170505->SetDbValueDef($rsnew, $this->f20170505->CurrentValue, NULL, $this->f20170505->ReadOnly);

			// f20170506
			$this->f20170506->SetDbValueDef($rsnew, $this->f20170506->CurrentValue, NULL, $this->f20170506->ReadOnly);

			// f20170507
			$this->f20170507->SetDbValueDef($rsnew, $this->f20170507->CurrentValue, NULL, $this->f20170507->ReadOnly);

			// f20170508
			$this->f20170508->SetDbValueDef($rsnew, $this->f20170508->CurrentValue, NULL, $this->f20170508->ReadOnly);

			// f20170509
			$this->f20170509->SetDbValueDef($rsnew, $this->f20170509->CurrentValue, NULL, $this->f20170509->ReadOnly);

			// f20170510
			$this->f20170510->SetDbValueDef($rsnew, $this->f20170510->CurrentValue, NULL, $this->f20170510->ReadOnly);

			// f20170511
			$this->f20170511->SetDbValueDef($rsnew, $this->f20170511->CurrentValue, NULL, $this->f20170511->ReadOnly);

			// f20170512
			$this->f20170512->SetDbValueDef($rsnew, $this->f20170512->CurrentValue, NULL, $this->f20170512->ReadOnly);

			// f20170513
			$this->f20170513->SetDbValueDef($rsnew, $this->f20170513->CurrentValue, NULL, $this->f20170513->ReadOnly);

			// f20170514
			$this->f20170514->SetDbValueDef($rsnew, $this->f20170514->CurrentValue, NULL, $this->f20170514->ReadOnly);

			// f20170515
			$this->f20170515->SetDbValueDef($rsnew, $this->f20170515->CurrentValue, NULL, $this->f20170515->ReadOnly);

			// f20170516
			$this->f20170516->SetDbValueDef($rsnew, $this->f20170516->CurrentValue, NULL, $this->f20170516->ReadOnly);

			// f20170517
			$this->f20170517->SetDbValueDef($rsnew, $this->f20170517->CurrentValue, NULL, $this->f20170517->ReadOnly);

			// f20170518
			$this->f20170518->SetDbValueDef($rsnew, $this->f20170518->CurrentValue, NULL, $this->f20170518->ReadOnly);

			// f20170519
			$this->f20170519->SetDbValueDef($rsnew, $this->f20170519->CurrentValue, NULL, $this->f20170519->ReadOnly);

			// f20170520
			$this->f20170520->SetDbValueDef($rsnew, $this->f20170520->CurrentValue, NULL, $this->f20170520->ReadOnly);

			// f20170521
			$this->f20170521->SetDbValueDef($rsnew, $this->f20170521->CurrentValue, NULL, $this->f20170521->ReadOnly);

			// f20170522
			$this->f20170522->SetDbValueDef($rsnew, $this->f20170522->CurrentValue, NULL, $this->f20170522->ReadOnly);

			// f20170523
			$this->f20170523->SetDbValueDef($rsnew, $this->f20170523->CurrentValue, NULL, $this->f20170523->ReadOnly);

			// f20170524
			$this->f20170524->SetDbValueDef($rsnew, $this->f20170524->CurrentValue, NULL, $this->f20170524->ReadOnly);

			// f20170525
			$this->f20170525->SetDbValueDef($rsnew, $this->f20170525->CurrentValue, NULL, $this->f20170525->ReadOnly);

			// f20170526
			$this->f20170526->SetDbValueDef($rsnew, $this->f20170526->CurrentValue, NULL, $this->f20170526->ReadOnly);

			// f20170527
			$this->f20170527->SetDbValueDef($rsnew, $this->f20170527->CurrentValue, NULL, $this->f20170527->ReadOnly);

			// f20170528
			$this->f20170528->SetDbValueDef($rsnew, $this->f20170528->CurrentValue, NULL, $this->f20170528->ReadOnly);

			// f20170529
			$this->f20170529->SetDbValueDef($rsnew, $this->f20170529->CurrentValue, NULL, $this->f20170529->ReadOnly);

			// f20170530
			$this->f20170530->SetDbValueDef($rsnew, $this->f20170530->CurrentValue, NULL, $this->f20170530->ReadOnly);

			// f20170531
			$this->f20170531->SetDbValueDef($rsnew, $this->f20170531->CurrentValue, NULL, $this->f20170531->ReadOnly);

			// f20170601
			$this->f20170601->SetDbValueDef($rsnew, $this->f20170601->CurrentValue, NULL, $this->f20170601->ReadOnly);

			// f20170602
			$this->f20170602->SetDbValueDef($rsnew, $this->f20170602->CurrentValue, NULL, $this->f20170602->ReadOnly);

			// f20170603
			$this->f20170603->SetDbValueDef($rsnew, $this->f20170603->CurrentValue, NULL, $this->f20170603->ReadOnly);

			// f20170604
			$this->f20170604->SetDbValueDef($rsnew, $this->f20170604->CurrentValue, NULL, $this->f20170604->ReadOnly);

			// f20170605
			$this->f20170605->SetDbValueDef($rsnew, $this->f20170605->CurrentValue, NULL, $this->f20170605->ReadOnly);

			// f20170606
			$this->f20170606->SetDbValueDef($rsnew, $this->f20170606->CurrentValue, NULL, $this->f20170606->ReadOnly);

			// f20170607
			$this->f20170607->SetDbValueDef($rsnew, $this->f20170607->CurrentValue, NULL, $this->f20170607->ReadOnly);

			// f20170608
			$this->f20170608->SetDbValueDef($rsnew, $this->f20170608->CurrentValue, NULL, $this->f20170608->ReadOnly);

			// f20170609
			$this->f20170609->SetDbValueDef($rsnew, $this->f20170609->CurrentValue, NULL, $this->f20170609->ReadOnly);

			// f20170610
			$this->f20170610->SetDbValueDef($rsnew, $this->f20170610->CurrentValue, NULL, $this->f20170610->ReadOnly);

			// f20170611
			$this->f20170611->SetDbValueDef($rsnew, $this->f20170611->CurrentValue, NULL, $this->f20170611->ReadOnly);

			// f20170612
			$this->f20170612->SetDbValueDef($rsnew, $this->f20170612->CurrentValue, NULL, $this->f20170612->ReadOnly);

			// f20170613
			$this->f20170613->SetDbValueDef($rsnew, $this->f20170613->CurrentValue, NULL, $this->f20170613->ReadOnly);

			// f20170614
			$this->f20170614->SetDbValueDef($rsnew, $this->f20170614->CurrentValue, NULL, $this->f20170614->ReadOnly);

			// f20170615
			$this->f20170615->SetDbValueDef($rsnew, $this->f20170615->CurrentValue, NULL, $this->f20170615->ReadOnly);

			// f20170616
			$this->f20170616->SetDbValueDef($rsnew, $this->f20170616->CurrentValue, NULL, $this->f20170616->ReadOnly);

			// f20170617
			$this->f20170617->SetDbValueDef($rsnew, $this->f20170617->CurrentValue, NULL, $this->f20170617->ReadOnly);

			// f20170618
			$this->f20170618->SetDbValueDef($rsnew, $this->f20170618->CurrentValue, NULL, $this->f20170618->ReadOnly);

			// f20170619
			$this->f20170619->SetDbValueDef($rsnew, $this->f20170619->CurrentValue, NULL, $this->f20170619->ReadOnly);

			// f20170620
			$this->f20170620->SetDbValueDef($rsnew, $this->f20170620->CurrentValue, NULL, $this->f20170620->ReadOnly);

			// f20170621
			$this->f20170621->SetDbValueDef($rsnew, $this->f20170621->CurrentValue, NULL, $this->f20170621->ReadOnly);

			// f20170622
			$this->f20170622->SetDbValueDef($rsnew, $this->f20170622->CurrentValue, NULL, $this->f20170622->ReadOnly);

			// f20170623
			$this->f20170623->SetDbValueDef($rsnew, $this->f20170623->CurrentValue, NULL, $this->f20170623->ReadOnly);

			// f20170624
			$this->f20170624->SetDbValueDef($rsnew, $this->f20170624->CurrentValue, NULL, $this->f20170624->ReadOnly);

			// f20170625
			$this->f20170625->SetDbValueDef($rsnew, $this->f20170625->CurrentValue, NULL, $this->f20170625->ReadOnly);

			// f20170626
			$this->f20170626->SetDbValueDef($rsnew, $this->f20170626->CurrentValue, NULL, $this->f20170626->ReadOnly);

			// f20170627
			$this->f20170627->SetDbValueDef($rsnew, $this->f20170627->CurrentValue, NULL, $this->f20170627->ReadOnly);

			// f20170628
			$this->f20170628->SetDbValueDef($rsnew, $this->f20170628->CurrentValue, NULL, $this->f20170628->ReadOnly);

			// f20170629
			$this->f20170629->SetDbValueDef($rsnew, $this->f20170629->CurrentValue, NULL, $this->f20170629->ReadOnly);

			// f20170630
			$this->f20170630->SetDbValueDef($rsnew, $this->f20170630->CurrentValue, NULL, $this->f20170630->ReadOnly);

			// f20170701
			$this->f20170701->SetDbValueDef($rsnew, $this->f20170701->CurrentValue, NULL, $this->f20170701->ReadOnly);

			// f20170702
			$this->f20170702->SetDbValueDef($rsnew, $this->f20170702->CurrentValue, NULL, $this->f20170702->ReadOnly);

			// f20170703
			$this->f20170703->SetDbValueDef($rsnew, $this->f20170703->CurrentValue, NULL, $this->f20170703->ReadOnly);

			// f20170704
			$this->f20170704->SetDbValueDef($rsnew, $this->f20170704->CurrentValue, NULL, $this->f20170704->ReadOnly);

			// f20170705
			$this->f20170705->SetDbValueDef($rsnew, $this->f20170705->CurrentValue, NULL, $this->f20170705->ReadOnly);

			// f20170706
			$this->f20170706->SetDbValueDef($rsnew, $this->f20170706->CurrentValue, NULL, $this->f20170706->ReadOnly);

			// f20170707
			$this->f20170707->SetDbValueDef($rsnew, $this->f20170707->CurrentValue, NULL, $this->f20170707->ReadOnly);

			// f20170708
			$this->f20170708->SetDbValueDef($rsnew, $this->f20170708->CurrentValue, NULL, $this->f20170708->ReadOnly);

			// f20170709
			$this->f20170709->SetDbValueDef($rsnew, $this->f20170709->CurrentValue, NULL, $this->f20170709->ReadOnly);

			// f20170710
			$this->f20170710->SetDbValueDef($rsnew, $this->f20170710->CurrentValue, NULL, $this->f20170710->ReadOnly);

			// f20170711
			$this->f20170711->SetDbValueDef($rsnew, $this->f20170711->CurrentValue, NULL, $this->f20170711->ReadOnly);

			// f20170712
			$this->f20170712->SetDbValueDef($rsnew, $this->f20170712->CurrentValue, NULL, $this->f20170712->ReadOnly);

			// f20170713
			$this->f20170713->SetDbValueDef($rsnew, $this->f20170713->CurrentValue, NULL, $this->f20170713->ReadOnly);

			// f20170714
			$this->f20170714->SetDbValueDef($rsnew, $this->f20170714->CurrentValue, NULL, $this->f20170714->ReadOnly);

			// f20170715
			$this->f20170715->SetDbValueDef($rsnew, $this->f20170715->CurrentValue, NULL, $this->f20170715->ReadOnly);

			// f20170716
			$this->f20170716->SetDbValueDef($rsnew, $this->f20170716->CurrentValue, NULL, $this->f20170716->ReadOnly);

			// f20170717
			$this->f20170717->SetDbValueDef($rsnew, $this->f20170717->CurrentValue, NULL, $this->f20170717->ReadOnly);

			// f20170718
			$this->f20170718->SetDbValueDef($rsnew, $this->f20170718->CurrentValue, NULL, $this->f20170718->ReadOnly);

			// f20170719
			$this->f20170719->SetDbValueDef($rsnew, $this->f20170719->CurrentValue, NULL, $this->f20170719->ReadOnly);

			// f20170720
			$this->f20170720->SetDbValueDef($rsnew, $this->f20170720->CurrentValue, NULL, $this->f20170720->ReadOnly);

			// f20170721
			$this->f20170721->SetDbValueDef($rsnew, $this->f20170721->CurrentValue, NULL, $this->f20170721->ReadOnly);

			// f20170722
			$this->f20170722->SetDbValueDef($rsnew, $this->f20170722->CurrentValue, NULL, $this->f20170722->ReadOnly);

			// f20170723
			$this->f20170723->SetDbValueDef($rsnew, $this->f20170723->CurrentValue, NULL, $this->f20170723->ReadOnly);

			// f20170724
			$this->f20170724->SetDbValueDef($rsnew, $this->f20170724->CurrentValue, NULL, $this->f20170724->ReadOnly);

			// f20170725
			$this->f20170725->SetDbValueDef($rsnew, $this->f20170725->CurrentValue, NULL, $this->f20170725->ReadOnly);

			// f20170726
			$this->f20170726->SetDbValueDef($rsnew, $this->f20170726->CurrentValue, NULL, $this->f20170726->ReadOnly);

			// f20170727
			$this->f20170727->SetDbValueDef($rsnew, $this->f20170727->CurrentValue, NULL, $this->f20170727->ReadOnly);

			// f20170728
			$this->f20170728->SetDbValueDef($rsnew, $this->f20170728->CurrentValue, NULL, $this->f20170728->ReadOnly);

			// f20170729
			$this->f20170729->SetDbValueDef($rsnew, $this->f20170729->CurrentValue, NULL, $this->f20170729->ReadOnly);

			// f20170730
			$this->f20170730->SetDbValueDef($rsnew, $this->f20170730->CurrentValue, NULL, $this->f20170730->ReadOnly);

			// f20170731
			$this->f20170731->SetDbValueDef($rsnew, $this->f20170731->CurrentValue, NULL, $this->f20170731->ReadOnly);

			// f20170801
			$this->f20170801->SetDbValueDef($rsnew, $this->f20170801->CurrentValue, NULL, $this->f20170801->ReadOnly);

			// f20170802
			$this->f20170802->SetDbValueDef($rsnew, $this->f20170802->CurrentValue, NULL, $this->f20170802->ReadOnly);

			// f20170803
			$this->f20170803->SetDbValueDef($rsnew, $this->f20170803->CurrentValue, NULL, $this->f20170803->ReadOnly);

			// f20170804
			$this->f20170804->SetDbValueDef($rsnew, $this->f20170804->CurrentValue, NULL, $this->f20170804->ReadOnly);

			// f20170805
			$this->f20170805->SetDbValueDef($rsnew, $this->f20170805->CurrentValue, NULL, $this->f20170805->ReadOnly);

			// f20170806
			$this->f20170806->SetDbValueDef($rsnew, $this->f20170806->CurrentValue, NULL, $this->f20170806->ReadOnly);

			// f20170807
			$this->f20170807->SetDbValueDef($rsnew, $this->f20170807->CurrentValue, NULL, $this->f20170807->ReadOnly);

			// f20170808
			$this->f20170808->SetDbValueDef($rsnew, $this->f20170808->CurrentValue, NULL, $this->f20170808->ReadOnly);

			// f20170809
			$this->f20170809->SetDbValueDef($rsnew, $this->f20170809->CurrentValue, NULL, $this->f20170809->ReadOnly);

			// f20170810
			$this->f20170810->SetDbValueDef($rsnew, $this->f20170810->CurrentValue, NULL, $this->f20170810->ReadOnly);

			// f20170811
			$this->f20170811->SetDbValueDef($rsnew, $this->f20170811->CurrentValue, NULL, $this->f20170811->ReadOnly);

			// f20170812
			$this->f20170812->SetDbValueDef($rsnew, $this->f20170812->CurrentValue, NULL, $this->f20170812->ReadOnly);

			// f20170813
			$this->f20170813->SetDbValueDef($rsnew, $this->f20170813->CurrentValue, NULL, $this->f20170813->ReadOnly);

			// f20170814
			$this->f20170814->SetDbValueDef($rsnew, $this->f20170814->CurrentValue, NULL, $this->f20170814->ReadOnly);

			// f20170815
			$this->f20170815->SetDbValueDef($rsnew, $this->f20170815->CurrentValue, NULL, $this->f20170815->ReadOnly);

			// f20170816
			$this->f20170816->SetDbValueDef($rsnew, $this->f20170816->CurrentValue, NULL, $this->f20170816->ReadOnly);

			// f20170817
			$this->f20170817->SetDbValueDef($rsnew, $this->f20170817->CurrentValue, NULL, $this->f20170817->ReadOnly);

			// f20170818
			$this->f20170818->SetDbValueDef($rsnew, $this->f20170818->CurrentValue, NULL, $this->f20170818->ReadOnly);

			// f20170819
			$this->f20170819->SetDbValueDef($rsnew, $this->f20170819->CurrentValue, NULL, $this->f20170819->ReadOnly);

			// f20170820
			$this->f20170820->SetDbValueDef($rsnew, $this->f20170820->CurrentValue, NULL, $this->f20170820->ReadOnly);

			// f20170821
			$this->f20170821->SetDbValueDef($rsnew, $this->f20170821->CurrentValue, NULL, $this->f20170821->ReadOnly);

			// f20170822
			$this->f20170822->SetDbValueDef($rsnew, $this->f20170822->CurrentValue, NULL, $this->f20170822->ReadOnly);

			// f20170823
			$this->f20170823->SetDbValueDef($rsnew, $this->f20170823->CurrentValue, NULL, $this->f20170823->ReadOnly);

			// f20170824
			$this->f20170824->SetDbValueDef($rsnew, $this->f20170824->CurrentValue, NULL, $this->f20170824->ReadOnly);

			// f20170825
			$this->f20170825->SetDbValueDef($rsnew, $this->f20170825->CurrentValue, NULL, $this->f20170825->ReadOnly);

			// f20170826
			$this->f20170826->SetDbValueDef($rsnew, $this->f20170826->CurrentValue, NULL, $this->f20170826->ReadOnly);

			// f20170827
			$this->f20170827->SetDbValueDef($rsnew, $this->f20170827->CurrentValue, NULL, $this->f20170827->ReadOnly);

			// f20170828
			$this->f20170828->SetDbValueDef($rsnew, $this->f20170828->CurrentValue, NULL, $this->f20170828->ReadOnly);

			// f20170829
			$this->f20170829->SetDbValueDef($rsnew, $this->f20170829->CurrentValue, NULL, $this->f20170829->ReadOnly);

			// f20170830
			$this->f20170830->SetDbValueDef($rsnew, $this->f20170830->CurrentValue, NULL, $this->f20170830->ReadOnly);

			// f20170831
			$this->f20170831->SetDbValueDef($rsnew, $this->f20170831->CurrentValue, NULL, $this->f20170831->ReadOnly);

			// f20170901
			$this->f20170901->SetDbValueDef($rsnew, $this->f20170901->CurrentValue, NULL, $this->f20170901->ReadOnly);

			// f20170902
			$this->f20170902->SetDbValueDef($rsnew, $this->f20170902->CurrentValue, NULL, $this->f20170902->ReadOnly);

			// f20170903
			$this->f20170903->SetDbValueDef($rsnew, $this->f20170903->CurrentValue, NULL, $this->f20170903->ReadOnly);

			// f20170904
			$this->f20170904->SetDbValueDef($rsnew, $this->f20170904->CurrentValue, NULL, $this->f20170904->ReadOnly);

			// f20170905
			$this->f20170905->SetDbValueDef($rsnew, $this->f20170905->CurrentValue, NULL, $this->f20170905->ReadOnly);

			// f20170906
			$this->f20170906->SetDbValueDef($rsnew, $this->f20170906->CurrentValue, NULL, $this->f20170906->ReadOnly);

			// f20170907
			$this->f20170907->SetDbValueDef($rsnew, $this->f20170907->CurrentValue, NULL, $this->f20170907->ReadOnly);

			// f20170908
			$this->f20170908->SetDbValueDef($rsnew, $this->f20170908->CurrentValue, NULL, $this->f20170908->ReadOnly);

			// f20170909
			$this->f20170909->SetDbValueDef($rsnew, $this->f20170909->CurrentValue, NULL, $this->f20170909->ReadOnly);

			// f20170910
			$this->f20170910->SetDbValueDef($rsnew, $this->f20170910->CurrentValue, NULL, $this->f20170910->ReadOnly);

			// f20170911
			$this->f20170911->SetDbValueDef($rsnew, $this->f20170911->CurrentValue, NULL, $this->f20170911->ReadOnly);

			// f20170912
			$this->f20170912->SetDbValueDef($rsnew, $this->f20170912->CurrentValue, NULL, $this->f20170912->ReadOnly);

			// f20170913
			$this->f20170913->SetDbValueDef($rsnew, $this->f20170913->CurrentValue, NULL, $this->f20170913->ReadOnly);

			// f20170914
			$this->f20170914->SetDbValueDef($rsnew, $this->f20170914->CurrentValue, NULL, $this->f20170914->ReadOnly);

			// f20170915
			$this->f20170915->SetDbValueDef($rsnew, $this->f20170915->CurrentValue, NULL, $this->f20170915->ReadOnly);

			// f20170916
			$this->f20170916->SetDbValueDef($rsnew, $this->f20170916->CurrentValue, NULL, $this->f20170916->ReadOnly);

			// f20170917
			$this->f20170917->SetDbValueDef($rsnew, $this->f20170917->CurrentValue, NULL, $this->f20170917->ReadOnly);

			// f20170918
			$this->f20170918->SetDbValueDef($rsnew, $this->f20170918->CurrentValue, NULL, $this->f20170918->ReadOnly);

			// f20170919
			$this->f20170919->SetDbValueDef($rsnew, $this->f20170919->CurrentValue, NULL, $this->f20170919->ReadOnly);

			// f20170920
			$this->f20170920->SetDbValueDef($rsnew, $this->f20170920->CurrentValue, NULL, $this->f20170920->ReadOnly);

			// f20170921
			$this->f20170921->SetDbValueDef($rsnew, $this->f20170921->CurrentValue, NULL, $this->f20170921->ReadOnly);

			// f20170922
			$this->f20170922->SetDbValueDef($rsnew, $this->f20170922->CurrentValue, NULL, $this->f20170922->ReadOnly);

			// f20170923
			$this->f20170923->SetDbValueDef($rsnew, $this->f20170923->CurrentValue, NULL, $this->f20170923->ReadOnly);

			// f20170924
			$this->f20170924->SetDbValueDef($rsnew, $this->f20170924->CurrentValue, NULL, $this->f20170924->ReadOnly);

			// f20170925
			$this->f20170925->SetDbValueDef($rsnew, $this->f20170925->CurrentValue, NULL, $this->f20170925->ReadOnly);

			// f20170926
			$this->f20170926->SetDbValueDef($rsnew, $this->f20170926->CurrentValue, NULL, $this->f20170926->ReadOnly);

			// f20170927
			$this->f20170927->SetDbValueDef($rsnew, $this->f20170927->CurrentValue, NULL, $this->f20170927->ReadOnly);

			// f20170928
			$this->f20170928->SetDbValueDef($rsnew, $this->f20170928->CurrentValue, NULL, $this->f20170928->ReadOnly);

			// f20170929
			$this->f20170929->SetDbValueDef($rsnew, $this->f20170929->CurrentValue, NULL, $this->f20170929->ReadOnly);

			// f20170930
			$this->f20170930->SetDbValueDef($rsnew, $this->f20170930->CurrentValue, NULL, $this->f20170930->ReadOnly);

			// f20171001
			$this->f20171001->SetDbValueDef($rsnew, $this->f20171001->CurrentValue, NULL, $this->f20171001->ReadOnly);

			// f20171002
			$this->f20171002->SetDbValueDef($rsnew, $this->f20171002->CurrentValue, NULL, $this->f20171002->ReadOnly);

			// f20171003
			$this->f20171003->SetDbValueDef($rsnew, $this->f20171003->CurrentValue, NULL, $this->f20171003->ReadOnly);

			// f20171004
			$this->f20171004->SetDbValueDef($rsnew, $this->f20171004->CurrentValue, NULL, $this->f20171004->ReadOnly);

			// f20171005
			$this->f20171005->SetDbValueDef($rsnew, $this->f20171005->CurrentValue, NULL, $this->f20171005->ReadOnly);

			// f20171006
			$this->f20171006->SetDbValueDef($rsnew, $this->f20171006->CurrentValue, NULL, $this->f20171006->ReadOnly);

			// f20171007
			$this->f20171007->SetDbValueDef($rsnew, $this->f20171007->CurrentValue, NULL, $this->f20171007->ReadOnly);

			// f20171008
			$this->f20171008->SetDbValueDef($rsnew, $this->f20171008->CurrentValue, NULL, $this->f20171008->ReadOnly);

			// f20171009
			$this->f20171009->SetDbValueDef($rsnew, $this->f20171009->CurrentValue, NULL, $this->f20171009->ReadOnly);

			// f20171010
			$this->f20171010->SetDbValueDef($rsnew, $this->f20171010->CurrentValue, NULL, $this->f20171010->ReadOnly);

			// f20171011
			$this->f20171011->SetDbValueDef($rsnew, $this->f20171011->CurrentValue, NULL, $this->f20171011->ReadOnly);

			// f20171012
			$this->f20171012->SetDbValueDef($rsnew, $this->f20171012->CurrentValue, NULL, $this->f20171012->ReadOnly);

			// f20171013
			$this->f20171013->SetDbValueDef($rsnew, $this->f20171013->CurrentValue, NULL, $this->f20171013->ReadOnly);

			// f20171014
			$this->f20171014->SetDbValueDef($rsnew, $this->f20171014->CurrentValue, NULL, $this->f20171014->ReadOnly);

			// f20171015
			$this->f20171015->SetDbValueDef($rsnew, $this->f20171015->CurrentValue, NULL, $this->f20171015->ReadOnly);

			// f20171016
			$this->f20171016->SetDbValueDef($rsnew, $this->f20171016->CurrentValue, NULL, $this->f20171016->ReadOnly);

			// f20171017
			$this->f20171017->SetDbValueDef($rsnew, $this->f20171017->CurrentValue, NULL, $this->f20171017->ReadOnly);

			// f20171018
			$this->f20171018->SetDbValueDef($rsnew, $this->f20171018->CurrentValue, NULL, $this->f20171018->ReadOnly);

			// f20171019
			$this->f20171019->SetDbValueDef($rsnew, $this->f20171019->CurrentValue, NULL, $this->f20171019->ReadOnly);

			// f20171020
			$this->f20171020->SetDbValueDef($rsnew, $this->f20171020->CurrentValue, NULL, $this->f20171020->ReadOnly);

			// f20171021
			$this->f20171021->SetDbValueDef($rsnew, $this->f20171021->CurrentValue, NULL, $this->f20171021->ReadOnly);

			// f20171022
			$this->f20171022->SetDbValueDef($rsnew, $this->f20171022->CurrentValue, NULL, $this->f20171022->ReadOnly);

			// f20171023
			$this->f20171023->SetDbValueDef($rsnew, $this->f20171023->CurrentValue, NULL, $this->f20171023->ReadOnly);

			// f20171024
			$this->f20171024->SetDbValueDef($rsnew, $this->f20171024->CurrentValue, NULL, $this->f20171024->ReadOnly);

			// f20171025
			$this->f20171025->SetDbValueDef($rsnew, $this->f20171025->CurrentValue, NULL, $this->f20171025->ReadOnly);

			// f20171026
			$this->f20171026->SetDbValueDef($rsnew, $this->f20171026->CurrentValue, NULL, $this->f20171026->ReadOnly);

			// f20171027
			$this->f20171027->SetDbValueDef($rsnew, $this->f20171027->CurrentValue, NULL, $this->f20171027->ReadOnly);

			// f20171028
			$this->f20171028->SetDbValueDef($rsnew, $this->f20171028->CurrentValue, NULL, $this->f20171028->ReadOnly);

			// f20171029
			$this->f20171029->SetDbValueDef($rsnew, $this->f20171029->CurrentValue, NULL, $this->f20171029->ReadOnly);

			// f20171030
			$this->f20171030->SetDbValueDef($rsnew, $this->f20171030->CurrentValue, NULL, $this->f20171030->ReadOnly);

			// f20171031
			$this->f20171031->SetDbValueDef($rsnew, $this->f20171031->CurrentValue, NULL, $this->f20171031->ReadOnly);

			// f20171101
			$this->f20171101->SetDbValueDef($rsnew, $this->f20171101->CurrentValue, NULL, $this->f20171101->ReadOnly);

			// f20171102
			$this->f20171102->SetDbValueDef($rsnew, $this->f20171102->CurrentValue, NULL, $this->f20171102->ReadOnly);

			// f20171103
			$this->f20171103->SetDbValueDef($rsnew, $this->f20171103->CurrentValue, NULL, $this->f20171103->ReadOnly);

			// f20171104
			$this->f20171104->SetDbValueDef($rsnew, $this->f20171104->CurrentValue, NULL, $this->f20171104->ReadOnly);

			// f20171105
			$this->f20171105->SetDbValueDef($rsnew, $this->f20171105->CurrentValue, NULL, $this->f20171105->ReadOnly);

			// f20171106
			$this->f20171106->SetDbValueDef($rsnew, $this->f20171106->CurrentValue, NULL, $this->f20171106->ReadOnly);

			// f20171107
			$this->f20171107->SetDbValueDef($rsnew, $this->f20171107->CurrentValue, NULL, $this->f20171107->ReadOnly);

			// f20171108
			$this->f20171108->SetDbValueDef($rsnew, $this->f20171108->CurrentValue, NULL, $this->f20171108->ReadOnly);

			// f20171109
			$this->f20171109->SetDbValueDef($rsnew, $this->f20171109->CurrentValue, NULL, $this->f20171109->ReadOnly);

			// f20171110
			$this->f20171110->SetDbValueDef($rsnew, $this->f20171110->CurrentValue, NULL, $this->f20171110->ReadOnly);

			// f20171111
			$this->f20171111->SetDbValueDef($rsnew, $this->f20171111->CurrentValue, NULL, $this->f20171111->ReadOnly);

			// f20171112
			$this->f20171112->SetDbValueDef($rsnew, $this->f20171112->CurrentValue, NULL, $this->f20171112->ReadOnly);

			// f20171113
			$this->f20171113->SetDbValueDef($rsnew, $this->f20171113->CurrentValue, NULL, $this->f20171113->ReadOnly);

			// f20171114
			$this->f20171114->SetDbValueDef($rsnew, $this->f20171114->CurrentValue, NULL, $this->f20171114->ReadOnly);

			// f20171115
			$this->f20171115->SetDbValueDef($rsnew, $this->f20171115->CurrentValue, NULL, $this->f20171115->ReadOnly);

			// f20171116
			$this->f20171116->SetDbValueDef($rsnew, $this->f20171116->CurrentValue, NULL, $this->f20171116->ReadOnly);

			// f20171117
			$this->f20171117->SetDbValueDef($rsnew, $this->f20171117->CurrentValue, NULL, $this->f20171117->ReadOnly);

			// f20171118
			$this->f20171118->SetDbValueDef($rsnew, $this->f20171118->CurrentValue, NULL, $this->f20171118->ReadOnly);

			// f20171119
			$this->f20171119->SetDbValueDef($rsnew, $this->f20171119->CurrentValue, NULL, $this->f20171119->ReadOnly);

			// f20171120
			$this->f20171120->SetDbValueDef($rsnew, $this->f20171120->CurrentValue, NULL, $this->f20171120->ReadOnly);

			// f20171121
			$this->f20171121->SetDbValueDef($rsnew, $this->f20171121->CurrentValue, NULL, $this->f20171121->ReadOnly);

			// f20171122
			$this->f20171122->SetDbValueDef($rsnew, $this->f20171122->CurrentValue, NULL, $this->f20171122->ReadOnly);

			// f20171123
			$this->f20171123->SetDbValueDef($rsnew, $this->f20171123->CurrentValue, NULL, $this->f20171123->ReadOnly);

			// f20171124
			$this->f20171124->SetDbValueDef($rsnew, $this->f20171124->CurrentValue, NULL, $this->f20171124->ReadOnly);

			// f20171125
			$this->f20171125->SetDbValueDef($rsnew, $this->f20171125->CurrentValue, NULL, $this->f20171125->ReadOnly);

			// f20171126
			$this->f20171126->SetDbValueDef($rsnew, $this->f20171126->CurrentValue, NULL, $this->f20171126->ReadOnly);

			// f20171127
			$this->f20171127->SetDbValueDef($rsnew, $this->f20171127->CurrentValue, NULL, $this->f20171127->ReadOnly);

			// f20171128
			$this->f20171128->SetDbValueDef($rsnew, $this->f20171128->CurrentValue, NULL, $this->f20171128->ReadOnly);

			// f20171129
			$this->f20171129->SetDbValueDef($rsnew, $this->f20171129->CurrentValue, NULL, $this->f20171129->ReadOnly);

			// f20171130
			$this->f20171130->SetDbValueDef($rsnew, $this->f20171130->CurrentValue, NULL, $this->f20171130->ReadOnly);

			// f20171201
			$this->f20171201->SetDbValueDef($rsnew, $this->f20171201->CurrentValue, NULL, $this->f20171201->ReadOnly);

			// f20171202
			$this->f20171202->SetDbValueDef($rsnew, $this->f20171202->CurrentValue, NULL, $this->f20171202->ReadOnly);

			// f20171203
			$this->f20171203->SetDbValueDef($rsnew, $this->f20171203->CurrentValue, NULL, $this->f20171203->ReadOnly);

			// f20171204
			$this->f20171204->SetDbValueDef($rsnew, $this->f20171204->CurrentValue, NULL, $this->f20171204->ReadOnly);

			// f20171205
			$this->f20171205->SetDbValueDef($rsnew, $this->f20171205->CurrentValue, NULL, $this->f20171205->ReadOnly);

			// f20171206
			$this->f20171206->SetDbValueDef($rsnew, $this->f20171206->CurrentValue, NULL, $this->f20171206->ReadOnly);

			// f20171207
			$this->f20171207->SetDbValueDef($rsnew, $this->f20171207->CurrentValue, NULL, $this->f20171207->ReadOnly);

			// f20171208
			$this->f20171208->SetDbValueDef($rsnew, $this->f20171208->CurrentValue, NULL, $this->f20171208->ReadOnly);

			// f20171209
			$this->f20171209->SetDbValueDef($rsnew, $this->f20171209->CurrentValue, NULL, $this->f20171209->ReadOnly);

			// f20171210
			$this->f20171210->SetDbValueDef($rsnew, $this->f20171210->CurrentValue, NULL, $this->f20171210->ReadOnly);

			// f20171211
			$this->f20171211->SetDbValueDef($rsnew, $this->f20171211->CurrentValue, NULL, $this->f20171211->ReadOnly);

			// f20171212
			$this->f20171212->SetDbValueDef($rsnew, $this->f20171212->CurrentValue, NULL, $this->f20171212->ReadOnly);

			// f20171213
			$this->f20171213->SetDbValueDef($rsnew, $this->f20171213->CurrentValue, NULL, $this->f20171213->ReadOnly);

			// f20171214
			$this->f20171214->SetDbValueDef($rsnew, $this->f20171214->CurrentValue, NULL, $this->f20171214->ReadOnly);

			// f20171215
			$this->f20171215->SetDbValueDef($rsnew, $this->f20171215->CurrentValue, NULL, $this->f20171215->ReadOnly);

			// f20171216
			$this->f20171216->SetDbValueDef($rsnew, $this->f20171216->CurrentValue, NULL, $this->f20171216->ReadOnly);

			// f20171217
			$this->f20171217->SetDbValueDef($rsnew, $this->f20171217->CurrentValue, NULL, $this->f20171217->ReadOnly);

			// f20171218
			$this->f20171218->SetDbValueDef($rsnew, $this->f20171218->CurrentValue, NULL, $this->f20171218->ReadOnly);

			// f20171219
			$this->f20171219->SetDbValueDef($rsnew, $this->f20171219->CurrentValue, NULL, $this->f20171219->ReadOnly);

			// f20171220
			$this->f20171220->SetDbValueDef($rsnew, $this->f20171220->CurrentValue, NULL, $this->f20171220->ReadOnly);

			// f20171221
			$this->f20171221->SetDbValueDef($rsnew, $this->f20171221->CurrentValue, NULL, $this->f20171221->ReadOnly);

			// f20171222
			$this->f20171222->SetDbValueDef($rsnew, $this->f20171222->CurrentValue, NULL, $this->f20171222->ReadOnly);

			// f20171223
			$this->f20171223->SetDbValueDef($rsnew, $this->f20171223->CurrentValue, NULL, $this->f20171223->ReadOnly);

			// f20171224
			$this->f20171224->SetDbValueDef($rsnew, $this->f20171224->CurrentValue, NULL, $this->f20171224->ReadOnly);

			// f20171225
			$this->f20171225->SetDbValueDef($rsnew, $this->f20171225->CurrentValue, NULL, $this->f20171225->ReadOnly);

			// f20171226
			$this->f20171226->SetDbValueDef($rsnew, $this->f20171226->CurrentValue, NULL, $this->f20171226->ReadOnly);

			// f20171227
			$this->f20171227->SetDbValueDef($rsnew, $this->f20171227->CurrentValue, NULL, $this->f20171227->ReadOnly);

			// f20171228
			$this->f20171228->SetDbValueDef($rsnew, $this->f20171228->CurrentValue, NULL, $this->f20171228->ReadOnly);

			// f20171229
			$this->f20171229->SetDbValueDef($rsnew, $this->f20171229->CurrentValue, NULL, $this->f20171229->ReadOnly);

			// f20171230
			$this->f20171230->SetDbValueDef($rsnew, $this->f20171230->CurrentValue, NULL, $this->f20171230->ReadOnly);

			// f20171231
			$this->f20171231->SetDbValueDef($rsnew, $this->f20171231->CurrentValue, NULL, $this->f20171231->ReadOnly);
...
// Create page object
if (!isset($t_jd_krj_peg_edit)) $t_jd_krj_peg_edit = new ct_jd_krj_peg_edit();

// Page init
$t_jd_krj_peg_edit->Page_Init();

// Page main
$t_jd_krj_peg_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_jd_krj_peg_edit->Page_Render();
?>
...
var CurrentForm = ft_jd_krj_pegedit = new ew_Form("ft_jd_krj_pegedit", "edit");

// Validate form
ft_jd_krj_pegedit.Validate = function() {
...
ft_jd_krj_pegedit.Form_CustomValidate = 
...
ft_jd_krj_pegedit.ValidateRequired = true;
<?php } else { ?>
ft_jd_krj_pegedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_jd_krj_pegedit.Lists["x_pegawai_id"] = {"LinkField":"x_pegawai_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_pegawai_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"pegawai"};
ft_jd_krj_pegedit.Lists["x_f20170102"] = {"LinkField":"x_jk_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_jk_nm","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_jk"};
ft_jd_krj_pegedit.Lists["x_f20171231"] = {"LinkField":"x_jk_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_jk_nm","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_jk"};
...
<?php if (!$t_jd_krj_peg_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t_jd_krj_peg_edit->ShowPageHeader(); ?>
<?php
$t_jd_krj_peg_edit->ShowMessage();
?>
<?php if (!$t_jd_krj_peg_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t_jd_krj_peg_edit->Pager)) $t_jd_krj_peg_edit->Pager = new cPrevNextPager($t_jd_krj_peg_edit->StartRec, $t_jd_krj_peg_edit->DisplayRecs, $t_jd_krj_peg_edit->TotalRecs) ?>
<?php if ($t_jd_krj_peg_edit->Pager->RecordCount > 0 && $t_jd_krj_peg_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t_jd_krj_peg_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t_jd_krj_peg_edit->PageUrl() ?>start=<?php echo $t_jd_krj_peg_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t_jd_krj_peg_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t_jd_krj_peg_edit->PageUrl() ?>start=<?php echo $t_jd_krj_peg_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t_jd_krj_peg_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t_jd_krj_peg_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t_jd_krj_peg_edit->PageUrl() ?>start=<?php echo $t_jd_krj_peg_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t_jd_krj_peg_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t_jd_krj_peg_edit->PageUrl() ?>start=<?php echo $t_jd_krj_peg_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t_jd_krj_peg_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="ft_jd_krj_pegedit" id="ft_jd_krj_pegedit" class="<?php echo $t_jd_krj_peg_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_jd_krj_peg_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_jd_krj_peg_edit->Token ?>">
<?php } ?>
...
<?php if ($t_jd_krj_peg->jdwkrjpeg_id->Visible) { // jdwkrjpeg_id ?>
	<div id="r_jdwkrjpeg_id" class="form-group">
		<label id="elh_t_jd_krj_peg_jdwkrjpeg_id" class="col-sm-2 control-label ewLabel"><?php echo $t_jd_krj_peg->jdwkrjpeg_id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t_jd_krj_peg->jdwkrjpeg_id->CellAttributes() ?>>
<span id="el_t_jd_krj_peg_jdwkrjpeg_id">
<span<?php echo $t_jd_krj_peg->jdwkrjpeg_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $t_jd_krj_peg->jdwkrjpeg_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="t_jd_krj_peg" data-field="x_jdwkrjpeg_id" name="x_jdwkrjpeg_id" id="x_jdwkrjpeg_id" value="<?php echo ew_HtmlEncode($t_jd_krj_peg->jdwkrjpeg_id->CurrentValue) ?>">
<?php echo $t_jd_krj_peg->jdwkrjpeg_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<script type="text/javascript">
ft_jd_krj_pegedit.CreateAutoSuggest({"id":"x_pegawai_id","forceSelect":true});
</script>
...
<script type="text/javascript">
ft_jd_krj_pegedit.CreateAutoSuggest({"id":"x_f20170102","forceSelect":true});
</script>
...
<script type="text/javascript">
ft_jd_krj_pegedit.CreateAutoSuggest({"id":"x_f20171231","forceSelect":true});
</script>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_jd_krj_peg_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($t_jd_krj_peg_edit->Pager)) $t_jd_krj_peg_edit->Pager = new cPrevNextPager($t_jd_krj_peg_edit->StartRec, $t_jd_krj_peg_edit->DisplayRecs, $t_jd_krj_peg_edit->TotalRecs) ?>
<?php if ($t_jd_krj_peg_edit->Pager->RecordCount > 0 && $t_jd_krj_peg_edit->Pager->Visible) { ?>
...
<script type="text/javascript">
ft_jd_krj_pegedit.Init();
</script>
<?php
$t_jd_krj_peg_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_jd_krj_peg_edit->Page_Terminate();
?>
