...
$t_jd_krj_peg_view = NULL; // Initialize page object first

class ct_jd_krj_peg_view extends ct_jd_krj_peg {
	...
	// Page object name
	var $PageObjName = 't_jd_krj_peg_view';
	...
	function __construct() {
		...
		if (@$_GET["jdwkrjpeg_id"] <> "") {
			$this->RecKey["jdwkrjpeg_id"] = $_GET["jdwkrjpeg_id"];
			$KeyUrl .= "&amp;jdwkrjpeg_id=" . urlencode($this->RecKey["jdwkrjpeg_id"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["jdwkrjpeg_id"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["jdwkrjpeg_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["jdwkrjpeg_id"] <> "") {
				...
				$this->RecKey["jdwkrjpeg_id"] = $this->jdwkrjpeg_id->QueryStringValue;
			} elseif (@$_POST["jdwkrjpeg_id"] <> "") {
				$this->jdwkrjpeg_id->setFormValue($_POST["jdwkrjpeg_id"]);
				$this->RecKey["jdwkrjpeg_id"] = $this->jdwkrjpeg_id->FormValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->Page_Terminate("t_jd_krj_peglist.php"); // Return to list page
						...
						while (!$this->Recordset->EOF) {
							if (strval($this->jdwkrjpeg_id->CurrentValue) == strval($this->Recordset->fields('jdwkrjpeg_id'))) {
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t_jd_krj_peglist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "t_jd_krj_peglist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t_jd_krj_peg_view)) $t_jd_krj_peg_view = new ct_jd_krj_peg_view();

// Page init
$t_jd_krj_peg_view->Page_Init();

// Page main
$t_jd_krj_peg_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_jd_krj_peg_view->Page_Render();
?>
...
var CurrentForm = ft_jd_krj_pegview = new ew_Form("ft_jd_krj_pegview", "view");

// Form_CustomValidate event
ft_jd_krj_pegview.Form_CustomValidate = 
...
ft_jd_krj_pegview.ValidateRequired = true;
<?php } else { ?>
ft_jd_krj_pegview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_jd_krj_pegview.Lists["x_pegawai_id"] = {"LinkField":"x_pegawai_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_pegawai_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"pegawai"};
ft_jd_krj_pegview.Lists["x_f20170102"] = {"LinkField":"x_jk_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_jk_nm","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_jk"};
ft_jd_krj_pegview.Lists["x_f20171231"] = {"LinkField":"x_jk_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_jk_nm","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_jk"};
...
<?php if ($t_jd_krj_peg->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t_jd_krj_peg_view->IsModal) { ?>
<?php if ($t_jd_krj_peg->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $t_jd_krj_peg_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t_jd_krj_peg_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t_jd_krj_peg_view->IsModal) { ?>
<?php if ($t_jd_krj_peg->Export == "") { ?>
...
<?php } ?>
<?php $t_jd_krj_peg_view->ShowPageHeader(); ?>
<?php
$t_jd_krj_peg_view->ShowMessage();
?>
<?php if (!$t_jd_krj_peg_view->IsModal) { ?>
<?php if ($t_jd_krj_peg->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t_jd_krj_peg_view->Pager)) $t_jd_krj_peg_view->Pager = new cPrevNextPager($t_jd_krj_peg_view->StartRec, $t_jd_krj_peg_view->DisplayRecs, $t_jd_krj_peg_view->TotalRecs) ?>
<?php if ($t_jd_krj_peg_view->Pager->RecordCount > 0 && $t_jd_krj_peg_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t_jd_krj_peg_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t_jd_krj_peg_view->PageUrl() ?>start=<?php echo $t_jd_krj_peg_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t_jd_krj_peg_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t_jd_krj_peg_view->PageUrl() ?>start=<?php echo $t_jd_krj_peg_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t_jd_krj_peg_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t_jd_krj_peg_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t_jd_krj_peg_view->PageUrl() ?>start=<?php echo $t_jd_krj_peg_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t_jd_krj_peg_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t_jd_krj_peg_view->PageUrl() ?>start=<?php echo $t_jd_krj_peg_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t_jd_krj_peg_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="ft_jd_krj_pegview" id="ft_jd_krj_pegview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_jd_krj_peg_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_jd_krj_peg_view->Token ?>">
<?php } ?>
...
<?php if ($t_jd_krj_peg->jdwkrjpeg_id->Visible) { // jdwkrjpeg_id ?>
	<tr id="r_jdwkrjpeg_id">
		<td><span id="elh_t_jd_krj_peg_jdwkrjpeg_id"><?php echo $t_jd_krj_peg->jdwkrjpeg_id->FldCaption() ?></span></td>
		<td data-name="jdwkrjpeg_id"<?php echo $t_jd_krj_peg->jdwkrjpeg_id->CellAttributes() ?>>
<span id="el_t_jd_krj_peg_jdwkrjpeg_id">
<span<?php echo $t_jd_krj_peg->jdwkrjpeg_id->ViewAttributes() ?>>
<?php echo $t_jd_krj_peg->jdwkrjpeg_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->pegawai_id->Visible) { // pegawai_id ?>
	<tr id="r_pegawai_id">
		<td><span id="elh_t_jd_krj_peg_pegawai_id"><?php echo $t_jd_krj_peg->pegawai_id->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->pegawai_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170101->Visible) { // f20170101 ?>
	<tr id="r_f20170101">
		<td><span id="elh_t_jd_krj_peg_f20170101"><?php echo $t_jd_krj_peg->f20170101->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170101->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170102->Visible) { // f20170102 ?>
	<tr id="r_f20170102">
		<td><span id="elh_t_jd_krj_peg_f20170102"><?php echo $t_jd_krj_peg->f20170102->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170102->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170103->Visible) { // f20170103 ?>
	<tr id="r_f20170103">
		<td><span id="elh_t_jd_krj_peg_f20170103"><?php echo $t_jd_krj_peg->f20170103->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170103->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170104->Visible) { // f20170104 ?>
	<tr id="r_f20170104">
		<td><span id="elh_t_jd_krj_peg_f20170104"><?php echo $t_jd_krj_peg->f20170104->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170104->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170105->Visible) { // f20170105 ?>
	<tr id="r_f20170105">
		<td><span id="elh_t_jd_krj_peg_f20170105"><?php echo $t_jd_krj_peg->f20170105->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170105->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170106->Visible) { // f20170106 ?>
	<tr id="r_f20170106">
		<td><span id="elh_t_jd_krj_peg_f20170106"><?php echo $t_jd_krj_peg->f20170106->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170106->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170107->Visible) { // f20170107 ?>
	<tr id="r_f20170107">
		<td><span id="elh_t_jd_krj_peg_f20170107"><?php echo $t_jd_krj_peg->f20170107->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170107->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170108->Visible) { // f20170108 ?>
	<tr id="r_f20170108">
		<td><span id="elh_t_jd_krj_peg_f20170108"><?php echo $t_jd_krj_peg->f20170108->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170108->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170109->Visible) { // f20170109 ?>
	<tr id="r_f20170109">
		<td><span id="elh_t_jd_krj_peg_f20170109"><?php echo $t_jd_krj_peg->f20170109->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170109->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170110->Visible) { // f20170110 ?>
	<tr id="r_f20170110">
		<td><span id="elh_t_jd_krj_peg_f20170110"><?php echo $t_jd_krj_peg->f20170110->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170110->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170111->Visible) { // f20170111 ?>
	<tr id="r_f20170111">
		<td><span id="elh_t_jd_krj_peg_f20170111"><?php echo $t_jd_krj_peg->f20170111->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170111->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170112->Visible) { // f20170112 ?>
	<tr id="r_f20170112">
		<td><span id="elh_t_jd_krj_peg_f20170112"><?php echo $t_jd_krj_peg->f20170112->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170112->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170113->Visible) { // f20170113 ?>
	<tr id="r_f20170113">
		<td><span id="elh_t_jd_krj_peg_f20170113"><?php echo $t_jd_krj_peg->f20170113->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170113->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170114->Visible) { // f20170114 ?>
	<tr id="r_f20170114">
		<td><span id="elh_t_jd_krj_peg_f20170114"><?php echo $t_jd_krj_peg->f20170114->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170114->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170115->Visible) { // f20170115 ?>
	<tr id="r_f20170115">
		<td><span id="elh_t_jd_krj_peg_f20170115"><?php echo $t_jd_krj_peg->f20170115->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170115->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170116->Visible) { // f20170116 ?>
	<tr id="r_f20170116">
		<td><span id="elh_t_jd_krj_peg_f20170116"><?php echo $t_jd_krj_peg->f20170116->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170116->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170117->Visible) { // f20170117 ?>
	<tr id="r_f20170117">
		<td><span id="elh_t_jd_krj_peg_f20170117"><?php echo $t_jd_krj_peg->f20170117->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170117->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170118->Visible) { // f20170118 ?>
	<tr id="r_f20170118">
		<td><span id="elh_t_jd_krj_peg_f20170118"><?php echo $t_jd_krj_peg->f20170118->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170118->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170119->Visible) { // f20170119 ?>
	<tr id="r_f20170119">
		<td><span id="elh_t_jd_krj_peg_f20170119"><?php echo $t_jd_krj_peg->f20170119->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170119->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170120->Visible) { // f20170120 ?>
	<tr id="r_f20170120">
		<td><span id="elh_t_jd_krj_peg_f20170120"><?php echo $t_jd_krj_peg->f20170120->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170120->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170121->Visible) { // f20170121 ?>
	<tr id="r_f20170121">
		<td><span id="elh_t_jd_krj_peg_f20170121"><?php echo $t_jd_krj_peg->f20170121->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170121->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170122->Visible) { // f20170122 ?>
	<tr id="r_f20170122">
		<td><span id="elh_t_jd_krj_peg_f20170122"><?php echo $t_jd_krj_peg->f20170122->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170122->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170123->Visible) { // f20170123 ?>
	<tr id="r_f20170123">
		<td><span id="elh_t_jd_krj_peg_f20170123"><?php echo $t_jd_krj_peg->f20170123->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170123->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170124->Visible) { // f20170124 ?>
	<tr id="r_f20170124">
		<td><span id="elh_t_jd_krj_peg_f20170124"><?php echo $t_jd_krj_peg->f20170124->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170124->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170125->Visible) { // f20170125 ?>
	<tr id="r_f20170125">
		<td><span id="elh_t_jd_krj_peg_f20170125"><?php echo $t_jd_krj_peg->f20170125->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170125->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170126->Visible) { // f20170126 ?>
	<tr id="r_f20170126">
		<td><span id="elh_t_jd_krj_peg_f20170126"><?php echo $t_jd_krj_peg->f20170126->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170126->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170127->Visible) { // f20170127 ?>
	<tr id="r_f20170127">
		<td><span id="elh_t_jd_krj_peg_f20170127"><?php echo $t_jd_krj_peg->f20170127->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170127->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170128->Visible) { // f20170128 ?>
	<tr id="r_f20170128">
		<td><span id="elh_t_jd_krj_peg_f20170128"><?php echo $t_jd_krj_peg->f20170128->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170128->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170129->Visible) { // f20170129 ?>
	<tr id="r_f20170129">
		<td><span id="elh_t_jd_krj_peg_f20170129"><?php echo $t_jd_krj_peg->f20170129->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170129->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170130->Visible) { // f20170130 ?>
	<tr id="r_f20170130">
		<td><span id="elh_t_jd_krj_peg_f20170130"><?php echo $t_jd_krj_peg->f20170130->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170130->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170131->Visible) { // f20170131 ?>
	<tr id="r_f20170131">
		<td><span id="elh_t_jd_krj_peg_f20170131"><?php echo $t_jd_krj_peg->f20170131->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170131->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170201->Visible) { // f20170201 ?>
	<tr id="r_f20170201">
		<td><span id="elh_t_jd_krj_peg_f20170201"><?php echo $t_jd_krj_peg->f20170201->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170201->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170202->Visible) { // f20170202 ?>
	<tr id="r_f20170202">
		<td><span id="elh_t_jd_krj_peg_f20170202"><?php echo $t_jd_krj_peg->f20170202->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170202->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170203->Visible) { // f20170203 ?>
	<tr id="r_f20170203">
		<td><span id="elh_t_jd_krj_peg_f20170203"><?php echo $t_jd_krj_peg->f20170203->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170203->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170204->Visible) { // f20170204 ?>
	<tr id="r_f20170204">
		<td><span id="elh_t_jd_krj_peg_f20170204"><?php echo $t_jd_krj_peg->f20170204->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170204->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170205->Visible) { // f20170205 ?>
	<tr id="r_f20170205">
		<td><span id="elh_t_jd_krj_peg_f20170205"><?php echo $t_jd_krj_peg->f20170205->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170205->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170206->Visible) { // f20170206 ?>
	<tr id="r_f20170206">
		<td><span id="elh_t_jd_krj_peg_f20170206"><?php echo $t_jd_krj_peg->f20170206->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170206->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170207->Visible) { // f20170207 ?>
	<tr id="r_f20170207">
		<td><span id="elh_t_jd_krj_peg_f20170207"><?php echo $t_jd_krj_peg->f20170207->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170207->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170208->Visible) { // f20170208 ?>
	<tr id="r_f20170208">
		<td><span id="elh_t_jd_krj_peg_f20170208"><?php echo $t_jd_krj_peg->f20170208->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170208->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170209->Visible) { // f20170209 ?>
	<tr id="r_f20170209">
		<td><span id="elh_t_jd_krj_peg_f20170209"><?php echo $t_jd_krj_peg->f20170209->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170209->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170210->Visible) { // f20170210 ?>
	<tr id="r_f20170210">
		<td><span id="elh_t_jd_krj_peg_f20170210"><?php echo $t_jd_krj_peg->f20170210->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170210->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170211->Visible) { // f20170211 ?>
	<tr id="r_f20170211">
		<td><span id="elh_t_jd_krj_peg_f20170211"><?php echo $t_jd_krj_peg->f20170211->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170211->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170212->Visible) { // f20170212 ?>
	<tr id="r_f20170212">
		<td><span id="elh_t_jd_krj_peg_f20170212"><?php echo $t_jd_krj_peg->f20170212->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170212->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170213->Visible) { // f20170213 ?>
	<tr id="r_f20170213">
		<td><span id="elh_t_jd_krj_peg_f20170213"><?php echo $t_jd_krj_peg->f20170213->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170213->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170214->Visible) { // f20170214 ?>
	<tr id="r_f20170214">
		<td><span id="elh_t_jd_krj_peg_f20170214"><?php echo $t_jd_krj_peg->f20170214->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170214->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170215->Visible) { // f20170215 ?>
	<tr id="r_f20170215">
		<td><span id="elh_t_jd_krj_peg_f20170215"><?php echo $t_jd_krj_peg->f20170215->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170215->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170216->Visible) { // f20170216 ?>
	<tr id="r_f20170216">
		<td><span id="elh_t_jd_krj_peg_f20170216"><?php echo $t_jd_krj_peg->f20170216->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170216->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170217->Visible) { // f20170217 ?>
	<tr id="r_f20170217">
		<td><span id="elh_t_jd_krj_peg_f20170217"><?php echo $t_jd_krj_peg->f20170217->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170217->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170218->Visible) { // f20170218 ?>
	<tr id="r_f20170218">
		<td><span id="elh_t_jd_krj_peg_f20170218"><?php echo $t_jd_krj_peg->f20170218->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170218->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170219->Visible) { // f20170219 ?>
	<tr id="r_f20170219">
		<td><span id="elh_t_jd_krj_peg_f20170219"><?php echo $t_jd_krj_peg->f20170219->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170219->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170220->Visible) { // f20170220 ?>
	<tr id="r_f20170220">
		<td><span id="elh_t_jd_krj_peg_f20170220"><?php echo $t_jd_krj_peg->f20170220->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170220->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170221->Visible) { // f20170221 ?>
	<tr id="r_f20170221">
		<td><span id="elh_t_jd_krj_peg_f20170221"><?php echo $t_jd_krj_peg->f20170221->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170221->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170222->Visible) { // f20170222 ?>
	<tr id="r_f20170222">
		<td><span id="elh_t_jd_krj_peg_f20170222"><?php echo $t_jd_krj_peg->f20170222->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170222->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170223->Visible) { // f20170223 ?>
	<tr id="r_f20170223">
		<td><span id="elh_t_jd_krj_peg_f20170223"><?php echo $t_jd_krj_peg->f20170223->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170223->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170224->Visible) { // f20170224 ?>
	<tr id="r_f20170224">
		<td><span id="elh_t_jd_krj_peg_f20170224"><?php echo $t_jd_krj_peg->f20170224->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170224->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170225->Visible) { // f20170225 ?>
	<tr id="r_f20170225">
		<td><span id="elh_t_jd_krj_peg_f20170225"><?php echo $t_jd_krj_peg->f20170225->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170225->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170226->Visible) { // f20170226 ?>
	<tr id="r_f20170226">
		<td><span id="elh_t_jd_krj_peg_f20170226"><?php echo $t_jd_krj_peg->f20170226->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170226->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170227->Visible) { // f20170227 ?>
	<tr id="r_f20170227">
		<td><span id="elh_t_jd_krj_peg_f20170227"><?php echo $t_jd_krj_peg->f20170227->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170227->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170228->Visible) { // f20170228 ?>
	<tr id="r_f20170228">
		<td><span id="elh_t_jd_krj_peg_f20170228"><?php echo $t_jd_krj_peg->f20170228->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170228->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170229->Visible) { // f20170229 ?>
	<tr id="r_f20170229">
		<td><span id="elh_t_jd_krj_peg_f20170229"><?php echo $t_jd_krj_peg->f20170229->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170229->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170301->Visible) { // f20170301 ?>
	<tr id="r_f20170301">
		<td><span id="elh_t_jd_krj_peg_f20170301"><?php echo $t_jd_krj_peg->f20170301->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170301->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170302->Visible) { // f20170302 ?>
	<tr id="r_f20170302">
		<td><span id="elh_t_jd_krj_peg_f20170302"><?php echo $t_jd_krj_peg->f20170302->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170302->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170303->Visible) { // f20170303 ?>
	<tr id="r_f20170303">
		<td><span id="elh_t_jd_krj_peg_f20170303"><?php echo $t_jd_krj_peg->f20170303->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170303->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170304->Visible) { // f20170304 ?>
	<tr id="r_f20170304">
		<td><span id="elh_t_jd_krj_peg_f20170304"><?php echo $t_jd_krj_peg->f20170304->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170304->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170305->Visible) { // f20170305 ?>
	<tr id="r_f20170305">
		<td><span id="elh_t_jd_krj_peg_f20170305"><?php echo $t_jd_krj_peg->f20170305->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170305->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170306->Visible) { // f20170306 ?>
	<tr id="r_f20170306">
		<td><span id="elh_t_jd_krj_peg_f20170306"><?php echo $t_jd_krj_peg->f20170306->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170306->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170307->Visible) { // f20170307 ?>
	<tr id="r_f20170307">
		<td><span id="elh_t_jd_krj_peg_f20170307"><?php echo $t_jd_krj_peg->f20170307->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170307->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170308->Visible) { // f20170308 ?>
	<tr id="r_f20170308">
		<td><span id="elh_t_jd_krj_peg_f20170308"><?php echo $t_jd_krj_peg->f20170308->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170308->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170309->Visible) { // f20170309 ?>
	<tr id="r_f20170309">
		<td><span id="elh_t_jd_krj_peg_f20170309"><?php echo $t_jd_krj_peg->f20170309->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170309->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170310->Visible) { // f20170310 ?>
	<tr id="r_f20170310">
		<td><span id="elh_t_jd_krj_peg_f20170310"><?php echo $t_jd_krj_peg->f20170310->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170310->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170311->Visible) { // f20170311 ?>
	<tr id="r_f20170311">
		<td><span id="elh_t_jd_krj_peg_f20170311"><?php echo $t_jd_krj_peg->f20170311->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170311->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170312->Visible) { // f20170312 ?>
	<tr id="r_f20170312">
		<td><span id="elh_t_jd_krj_peg_f20170312"><?php echo $t_jd_krj_peg->f20170312->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170312->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170313->Visible) { // f20170313 ?>
	<tr id="r_f20170313">
		<td><span id="elh_t_jd_krj_peg_f20170313"><?php echo $t_jd_krj_peg->f20170313->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170313->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170314->Visible) { // f20170314 ?>
	<tr id="r_f20170314">
		<td><span id="elh_t_jd_krj_peg_f20170314"><?php echo $t_jd_krj_peg->f20170314->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170314->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170315->Visible) { // f20170315 ?>
	<tr id="r_f20170315">
		<td><span id="elh_t_jd_krj_peg_f20170315"><?php echo $t_jd_krj_peg->f20170315->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170315->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170316->Visible) { // f20170316 ?>
	<tr id="r_f20170316">
		<td><span id="elh_t_jd_krj_peg_f20170316"><?php echo $t_jd_krj_peg->f20170316->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170316->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170317->Visible) { // f20170317 ?>
	<tr id="r_f20170317">
		<td><span id="elh_t_jd_krj_peg_f20170317"><?php echo $t_jd_krj_peg->f20170317->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170317->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170318->Visible) { // f20170318 ?>
	<tr id="r_f20170318">
		<td><span id="elh_t_jd_krj_peg_f20170318"><?php echo $t_jd_krj_peg->f20170318->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170318->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170319->Visible) { // f20170319 ?>
	<tr id="r_f20170319">
		<td><span id="elh_t_jd_krj_peg_f20170319"><?php echo $t_jd_krj_peg->f20170319->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170319->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170320->Visible) { // f20170320 ?>
	<tr id="r_f20170320">
		<td><span id="elh_t_jd_krj_peg_f20170320"><?php echo $t_jd_krj_peg->f20170320->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170320->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170321->Visible) { // f20170321 ?>
	<tr id="r_f20170321">
		<td><span id="elh_t_jd_krj_peg_f20170321"><?php echo $t_jd_krj_peg->f20170321->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170321->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170322->Visible) { // f20170322 ?>
	<tr id="r_f20170322">
		<td><span id="elh_t_jd_krj_peg_f20170322"><?php echo $t_jd_krj_peg->f20170322->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170322->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170323->Visible) { // f20170323 ?>
	<tr id="r_f20170323">
		<td><span id="elh_t_jd_krj_peg_f20170323"><?php echo $t_jd_krj_peg->f20170323->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170323->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170324->Visible) { // f20170324 ?>
	<tr id="r_f20170324">
		<td><span id="elh_t_jd_krj_peg_f20170324"><?php echo $t_jd_krj_peg->f20170324->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170324->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170325->Visible) { // f20170325 ?>
	<tr id="r_f20170325">
		<td><span id="elh_t_jd_krj_peg_f20170325"><?php echo $t_jd_krj_peg->f20170325->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170325->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170326->Visible) { // f20170326 ?>
	<tr id="r_f20170326">
		<td><span id="elh_t_jd_krj_peg_f20170326"><?php echo $t_jd_krj_peg->f20170326->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170326->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170327->Visible) { // f20170327 ?>
	<tr id="r_f20170327">
		<td><span id="elh_t_jd_krj_peg_f20170327"><?php echo $t_jd_krj_peg->f20170327->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170327->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170328->Visible) { // f20170328 ?>
	<tr id="r_f20170328">
		<td><span id="elh_t_jd_krj_peg_f20170328"><?php echo $t_jd_krj_peg->f20170328->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170328->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170329->Visible) { // f20170329 ?>
	<tr id="r_f20170329">
		<td><span id="elh_t_jd_krj_peg_f20170329"><?php echo $t_jd_krj_peg->f20170329->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170329->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170330->Visible) { // f20170330 ?>
	<tr id="r_f20170330">
		<td><span id="elh_t_jd_krj_peg_f20170330"><?php echo $t_jd_krj_peg->f20170330->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170330->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170331->Visible) { // f20170331 ?>
	<tr id="r_f20170331">
		<td><span id="elh_t_jd_krj_peg_f20170331"><?php echo $t_jd_krj_peg->f20170331->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170331->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170401->Visible) { // f20170401 ?>
	<tr id="r_f20170401">
		<td><span id="elh_t_jd_krj_peg_f20170401"><?php echo $t_jd_krj_peg->f20170401->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170401->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170402->Visible) { // f20170402 ?>
	<tr id="r_f20170402">
		<td><span id="elh_t_jd_krj_peg_f20170402"><?php echo $t_jd_krj_peg->f20170402->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170402->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170403->Visible) { // f20170403 ?>
	<tr id="r_f20170403">
		<td><span id="elh_t_jd_krj_peg_f20170403"><?php echo $t_jd_krj_peg->f20170403->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170403->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170404->Visible) { // f20170404 ?>
	<tr id="r_f20170404">
		<td><span id="elh_t_jd_krj_peg_f20170404"><?php echo $t_jd_krj_peg->f20170404->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170404->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170405->Visible) { // f20170405 ?>
	<tr id="r_f20170405">
		<td><span id="elh_t_jd_krj_peg_f20170405"><?php echo $t_jd_krj_peg->f20170405->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170405->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170406->Visible) { // f20170406 ?>
	<tr id="r_f20170406">
		<td><span id="elh_t_jd_krj_peg_f20170406"><?php echo $t_jd_krj_peg->f20170406->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170406->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170407->Visible) { // f20170407 ?>
	<tr id="r_f20170407">
		<td><span id="elh_t_jd_krj_peg_f20170407"><?php echo $t_jd_krj_peg->f20170407->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170407->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170408->Visible) { // f20170408 ?>
	<tr id="r_f20170408">
		<td><span id="elh_t_jd_krj_peg_f20170408"><?php echo $t_jd_krj_peg->f20170408->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170408->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170409->Visible) { // f20170409 ?>
	<tr id="r_f20170409">
		<td><span id="elh_t_jd_krj_peg_f20170409"><?php echo $t_jd_krj_peg->f20170409->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170409->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170410->Visible) { // f20170410 ?>
	<tr id="r_f20170410">
		<td><span id="elh_t_jd_krj_peg_f20170410"><?php echo $t_jd_krj_peg->f20170410->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170410->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170411->Visible) { // f20170411 ?>
	<tr id="r_f20170411">
		<td><span id="elh_t_jd_krj_peg_f20170411"><?php echo $t_jd_krj_peg->f20170411->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170411->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170412->Visible) { // f20170412 ?>
	<tr id="r_f20170412">
		<td><span id="elh_t_jd_krj_peg_f20170412"><?php echo $t_jd_krj_peg->f20170412->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170412->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170413->Visible) { // f20170413 ?>
	<tr id="r_f20170413">
		<td><span id="elh_t_jd_krj_peg_f20170413"><?php echo $t_jd_krj_peg->f20170413->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170413->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170414->Visible) { // f20170414 ?>
	<tr id="r_f20170414">
		<td><span id="elh_t_jd_krj_peg_f20170414"><?php echo $t_jd_krj_peg->f20170414->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170414->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170415->Visible) { // f20170415 ?>
	<tr id="r_f20170415">
		<td><span id="elh_t_jd_krj_peg_f20170415"><?php echo $t_jd_krj_peg->f20170415->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170415->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170416->Visible) { // f20170416 ?>
	<tr id="r_f20170416">
		<td><span id="elh_t_jd_krj_peg_f20170416"><?php echo $t_jd_krj_peg->f20170416->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170416->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170417->Visible) { // f20170417 ?>
	<tr id="r_f20170417">
		<td><span id="elh_t_jd_krj_peg_f20170417"><?php echo $t_jd_krj_peg->f20170417->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170417->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170418->Visible) { // f20170418 ?>
	<tr id="r_f20170418">
		<td><span id="elh_t_jd_krj_peg_f20170418"><?php echo $t_jd_krj_peg->f20170418->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170418->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170419->Visible) { // f20170419 ?>
	<tr id="r_f20170419">
		<td><span id="elh_t_jd_krj_peg_f20170419"><?php echo $t_jd_krj_peg->f20170419->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170419->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170420->Visible) { // f20170420 ?>
	<tr id="r_f20170420">
		<td><span id="elh_t_jd_krj_peg_f20170420"><?php echo $t_jd_krj_peg->f20170420->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170420->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170421->Visible) { // f20170421 ?>
	<tr id="r_f20170421">
		<td><span id="elh_t_jd_krj_peg_f20170421"><?php echo $t_jd_krj_peg->f20170421->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170421->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170422->Visible) { // f20170422 ?>
	<tr id="r_f20170422">
		<td><span id="elh_t_jd_krj_peg_f20170422"><?php echo $t_jd_krj_peg->f20170422->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170422->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170423->Visible) { // f20170423 ?>
	<tr id="r_f20170423">
		<td><span id="elh_t_jd_krj_peg_f20170423"><?php echo $t_jd_krj_peg->f20170423->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170423->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170424->Visible) { // f20170424 ?>
	<tr id="r_f20170424">
		<td><span id="elh_t_jd_krj_peg_f20170424"><?php echo $t_jd_krj_peg->f20170424->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170424->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170425->Visible) { // f20170425 ?>
	<tr id="r_f20170425">
		<td><span id="elh_t_jd_krj_peg_f20170425"><?php echo $t_jd_krj_peg->f20170425->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170425->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170426->Visible) { // f20170426 ?>
	<tr id="r_f20170426">
		<td><span id="elh_t_jd_krj_peg_f20170426"><?php echo $t_jd_krj_peg->f20170426->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170426->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170427->Visible) { // f20170427 ?>
	<tr id="r_f20170427">
		<td><span id="elh_t_jd_krj_peg_f20170427"><?php echo $t_jd_krj_peg->f20170427->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170427->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170428->Visible) { // f20170428 ?>
	<tr id="r_f20170428">
		<td><span id="elh_t_jd_krj_peg_f20170428"><?php echo $t_jd_krj_peg->f20170428->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170428->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170429->Visible) { // f20170429 ?>
	<tr id="r_f20170429">
		<td><span id="elh_t_jd_krj_peg_f20170429"><?php echo $t_jd_krj_peg->f20170429->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170429->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170430->Visible) { // f20170430 ?>
	<tr id="r_f20170430">
		<td><span id="elh_t_jd_krj_peg_f20170430"><?php echo $t_jd_krj_peg->f20170430->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170430->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170501->Visible) { // f20170501 ?>
	<tr id="r_f20170501">
		<td><span id="elh_t_jd_krj_peg_f20170501"><?php echo $t_jd_krj_peg->f20170501->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170501->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170502->Visible) { // f20170502 ?>
	<tr id="r_f20170502">
		<td><span id="elh_t_jd_krj_peg_f20170502"><?php echo $t_jd_krj_peg->f20170502->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170502->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170503->Visible) { // f20170503 ?>
	<tr id="r_f20170503">
		<td><span id="elh_t_jd_krj_peg_f20170503"><?php echo $t_jd_krj_peg->f20170503->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170503->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170504->Visible) { // f20170504 ?>
	<tr id="r_f20170504">
		<td><span id="elh_t_jd_krj_peg_f20170504"><?php echo $t_jd_krj_peg->f20170504->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170504->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170505->Visible) { // f20170505 ?>
	<tr id="r_f20170505">
		<td><span id="elh_t_jd_krj_peg_f20170505"><?php echo $t_jd_krj_peg->f20170505->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170505->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170506->Visible) { // f20170506 ?>
	<tr id="r_f20170506">
		<td><span id="elh_t_jd_krj_peg_f20170506"><?php echo $t_jd_krj_peg->f20170506->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170506->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170507->Visible) { // f20170507 ?>
	<tr id="r_f20170507">
		<td><span id="elh_t_jd_krj_peg_f20170507"><?php echo $t_jd_krj_peg->f20170507->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170507->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170508->Visible) { // f20170508 ?>
	<tr id="r_f20170508">
		<td><span id="elh_t_jd_krj_peg_f20170508"><?php echo $t_jd_krj_peg->f20170508->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170508->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170509->Visible) { // f20170509 ?>
	<tr id="r_f20170509">
		<td><span id="elh_t_jd_krj_peg_f20170509"><?php echo $t_jd_krj_peg->f20170509->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170509->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170510->Visible) { // f20170510 ?>
	<tr id="r_f20170510">
		<td><span id="elh_t_jd_krj_peg_f20170510"><?php echo $t_jd_krj_peg->f20170510->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170510->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170511->Visible) { // f20170511 ?>
	<tr id="r_f20170511">
		<td><span id="elh_t_jd_krj_peg_f20170511"><?php echo $t_jd_krj_peg->f20170511->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170511->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170512->Visible) { // f20170512 ?>
	<tr id="r_f20170512">
		<td><span id="elh_t_jd_krj_peg_f20170512"><?php echo $t_jd_krj_peg->f20170512->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170512->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170513->Visible) { // f20170513 ?>
	<tr id="r_f20170513">
		<td><span id="elh_t_jd_krj_peg_f20170513"><?php echo $t_jd_krj_peg->f20170513->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170513->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170514->Visible) { // f20170514 ?>
	<tr id="r_f20170514">
		<td><span id="elh_t_jd_krj_peg_f20170514"><?php echo $t_jd_krj_peg->f20170514->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170514->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170515->Visible) { // f20170515 ?>
	<tr id="r_f20170515">
		<td><span id="elh_t_jd_krj_peg_f20170515"><?php echo $t_jd_krj_peg->f20170515->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170515->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170516->Visible) { // f20170516 ?>
	<tr id="r_f20170516">
		<td><span id="elh_t_jd_krj_peg_f20170516"><?php echo $t_jd_krj_peg->f20170516->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170516->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170517->Visible) { // f20170517 ?>
	<tr id="r_f20170517">
		<td><span id="elh_t_jd_krj_peg_f20170517"><?php echo $t_jd_krj_peg->f20170517->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170517->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170518->Visible) { // f20170518 ?>
	<tr id="r_f20170518">
		<td><span id="elh_t_jd_krj_peg_f20170518"><?php echo $t_jd_krj_peg->f20170518->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170518->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170519->Visible) { // f20170519 ?>
	<tr id="r_f20170519">
		<td><span id="elh_t_jd_krj_peg_f20170519"><?php echo $t_jd_krj_peg->f20170519->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170519->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170520->Visible) { // f20170520 ?>
	<tr id="r_f20170520">
		<td><span id="elh_t_jd_krj_peg_f20170520"><?php echo $t_jd_krj_peg->f20170520->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170520->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170521->Visible) { // f20170521 ?>
	<tr id="r_f20170521">
		<td><span id="elh_t_jd_krj_peg_f20170521"><?php echo $t_jd_krj_peg->f20170521->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170521->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170522->Visible) { // f20170522 ?>
	<tr id="r_f20170522">
		<td><span id="elh_t_jd_krj_peg_f20170522"><?php echo $t_jd_krj_peg->f20170522->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170522->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170523->Visible) { // f20170523 ?>
	<tr id="r_f20170523">
		<td><span id="elh_t_jd_krj_peg_f20170523"><?php echo $t_jd_krj_peg->f20170523->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170523->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170524->Visible) { // f20170524 ?>
	<tr id="r_f20170524">
		<td><span id="elh_t_jd_krj_peg_f20170524"><?php echo $t_jd_krj_peg->f20170524->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170524->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170525->Visible) { // f20170525 ?>
	<tr id="r_f20170525">
		<td><span id="elh_t_jd_krj_peg_f20170525"><?php echo $t_jd_krj_peg->f20170525->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170525->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170526->Visible) { // f20170526 ?>
	<tr id="r_f20170526">
		<td><span id="elh_t_jd_krj_peg_f20170526"><?php echo $t_jd_krj_peg->f20170526->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170526->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170527->Visible) { // f20170527 ?>
	<tr id="r_f20170527">
		<td><span id="elh_t_jd_krj_peg_f20170527"><?php echo $t_jd_krj_peg->f20170527->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170527->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170528->Visible) { // f20170528 ?>
	<tr id="r_f20170528">
		<td><span id="elh_t_jd_krj_peg_f20170528"><?php echo $t_jd_krj_peg->f20170528->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170528->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170529->Visible) { // f20170529 ?>
	<tr id="r_f20170529">
		<td><span id="elh_t_jd_krj_peg_f20170529"><?php echo $t_jd_krj_peg->f20170529->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170529->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170530->Visible) { // f20170530 ?>
	<tr id="r_f20170530">
		<td><span id="elh_t_jd_krj_peg_f20170530"><?php echo $t_jd_krj_peg->f20170530->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170530->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170531->Visible) { // f20170531 ?>
	<tr id="r_f20170531">
		<td><span id="elh_t_jd_krj_peg_f20170531"><?php echo $t_jd_krj_peg->f20170531->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170531->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170601->Visible) { // f20170601 ?>
	<tr id="r_f20170601">
		<td><span id="elh_t_jd_krj_peg_f20170601"><?php echo $t_jd_krj_peg->f20170601->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170601->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170602->Visible) { // f20170602 ?>
	<tr id="r_f20170602">
		<td><span id="elh_t_jd_krj_peg_f20170602"><?php echo $t_jd_krj_peg->f20170602->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170602->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170603->Visible) { // f20170603 ?>
	<tr id="r_f20170603">
		<td><span id="elh_t_jd_krj_peg_f20170603"><?php echo $t_jd_krj_peg->f20170603->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170603->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170604->Visible) { // f20170604 ?>
	<tr id="r_f20170604">
		<td><span id="elh_t_jd_krj_peg_f20170604"><?php echo $t_jd_krj_peg->f20170604->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170604->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170605->Visible) { // f20170605 ?>
	<tr id="r_f20170605">
		<td><span id="elh_t_jd_krj_peg_f20170605"><?php echo $t_jd_krj_peg->f20170605->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170605->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170606->Visible) { // f20170606 ?>
	<tr id="r_f20170606">
		<td><span id="elh_t_jd_krj_peg_f20170606"><?php echo $t_jd_krj_peg->f20170606->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170606->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170607->Visible) { // f20170607 ?>
	<tr id="r_f20170607">
		<td><span id="elh_t_jd_krj_peg_f20170607"><?php echo $t_jd_krj_peg->f20170607->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170607->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170608->Visible) { // f20170608 ?>
	<tr id="r_f20170608">
		<td><span id="elh_t_jd_krj_peg_f20170608"><?php echo $t_jd_krj_peg->f20170608->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170608->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170609->Visible) { // f20170609 ?>
	<tr id="r_f20170609">
		<td><span id="elh_t_jd_krj_peg_f20170609"><?php echo $t_jd_krj_peg->f20170609->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170609->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170610->Visible) { // f20170610 ?>
	<tr id="r_f20170610">
		<td><span id="elh_t_jd_krj_peg_f20170610"><?php echo $t_jd_krj_peg->f20170610->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170610->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170611->Visible) { // f20170611 ?>
	<tr id="r_f20170611">
		<td><span id="elh_t_jd_krj_peg_f20170611"><?php echo $t_jd_krj_peg->f20170611->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170611->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170612->Visible) { // f20170612 ?>
	<tr id="r_f20170612">
		<td><span id="elh_t_jd_krj_peg_f20170612"><?php echo $t_jd_krj_peg->f20170612->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170612->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170613->Visible) { // f20170613 ?>
	<tr id="r_f20170613">
		<td><span id="elh_t_jd_krj_peg_f20170613"><?php echo $t_jd_krj_peg->f20170613->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170613->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170614->Visible) { // f20170614 ?>
	<tr id="r_f20170614">
		<td><span id="elh_t_jd_krj_peg_f20170614"><?php echo $t_jd_krj_peg->f20170614->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170614->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170615->Visible) { // f20170615 ?>
	<tr id="r_f20170615">
		<td><span id="elh_t_jd_krj_peg_f20170615"><?php echo $t_jd_krj_peg->f20170615->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170615->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170616->Visible) { // f20170616 ?>
	<tr id="r_f20170616">
		<td><span id="elh_t_jd_krj_peg_f20170616"><?php echo $t_jd_krj_peg->f20170616->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170616->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170617->Visible) { // f20170617 ?>
	<tr id="r_f20170617">
		<td><span id="elh_t_jd_krj_peg_f20170617"><?php echo $t_jd_krj_peg->f20170617->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170617->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170618->Visible) { // f20170618 ?>
	<tr id="r_f20170618">
		<td><span id="elh_t_jd_krj_peg_f20170618"><?php echo $t_jd_krj_peg->f20170618->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170618->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170619->Visible) { // f20170619 ?>
	<tr id="r_f20170619">
		<td><span id="elh_t_jd_krj_peg_f20170619"><?php echo $t_jd_krj_peg->f20170619->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170619->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170620->Visible) { // f20170620 ?>
	<tr id="r_f20170620">
		<td><span id="elh_t_jd_krj_peg_f20170620"><?php echo $t_jd_krj_peg->f20170620->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170620->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170621->Visible) { // f20170621 ?>
	<tr id="r_f20170621">
		<td><span id="elh_t_jd_krj_peg_f20170621"><?php echo $t_jd_krj_peg->f20170621->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170621->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170622->Visible) { // f20170622 ?>
	<tr id="r_f20170622">
		<td><span id="elh_t_jd_krj_peg_f20170622"><?php echo $t_jd_krj_peg->f20170622->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170622->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170623->Visible) { // f20170623 ?>
	<tr id="r_f20170623">
		<td><span id="elh_t_jd_krj_peg_f20170623"><?php echo $t_jd_krj_peg->f20170623->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170623->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170624->Visible) { // f20170624 ?>
	<tr id="r_f20170624">
		<td><span id="elh_t_jd_krj_peg_f20170624"><?php echo $t_jd_krj_peg->f20170624->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170624->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170625->Visible) { // f20170625 ?>
	<tr id="r_f20170625">
		<td><span id="elh_t_jd_krj_peg_f20170625"><?php echo $t_jd_krj_peg->f20170625->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170625->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170626->Visible) { // f20170626 ?>
	<tr id="r_f20170626">
		<td><span id="elh_t_jd_krj_peg_f20170626"><?php echo $t_jd_krj_peg->f20170626->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170626->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170627->Visible) { // f20170627 ?>
	<tr id="r_f20170627">
		<td><span id="elh_t_jd_krj_peg_f20170627"><?php echo $t_jd_krj_peg->f20170627->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170627->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170628->Visible) { // f20170628 ?>
	<tr id="r_f20170628">
		<td><span id="elh_t_jd_krj_peg_f20170628"><?php echo $t_jd_krj_peg->f20170628->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170628->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170629->Visible) { // f20170629 ?>
	<tr id="r_f20170629">
		<td><span id="elh_t_jd_krj_peg_f20170629"><?php echo $t_jd_krj_peg->f20170629->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170629->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170630->Visible) { // f20170630 ?>
	<tr id="r_f20170630">
		<td><span id="elh_t_jd_krj_peg_f20170630"><?php echo $t_jd_krj_peg->f20170630->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170630->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170701->Visible) { // f20170701 ?>
	<tr id="r_f20170701">
		<td><span id="elh_t_jd_krj_peg_f20170701"><?php echo $t_jd_krj_peg->f20170701->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170701->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170702->Visible) { // f20170702 ?>
	<tr id="r_f20170702">
		<td><span id="elh_t_jd_krj_peg_f20170702"><?php echo $t_jd_krj_peg->f20170702->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170702->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170703->Visible) { // f20170703 ?>
	<tr id="r_f20170703">
		<td><span id="elh_t_jd_krj_peg_f20170703"><?php echo $t_jd_krj_peg->f20170703->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170703->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170704->Visible) { // f20170704 ?>
	<tr id="r_f20170704">
		<td><span id="elh_t_jd_krj_peg_f20170704"><?php echo $t_jd_krj_peg->f20170704->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170704->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170705->Visible) { // f20170705 ?>
	<tr id="r_f20170705">
		<td><span id="elh_t_jd_krj_peg_f20170705"><?php echo $t_jd_krj_peg->f20170705->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170705->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170706->Visible) { // f20170706 ?>
	<tr id="r_f20170706">
		<td><span id="elh_t_jd_krj_peg_f20170706"><?php echo $t_jd_krj_peg->f20170706->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170706->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170707->Visible) { // f20170707 ?>
	<tr id="r_f20170707">
		<td><span id="elh_t_jd_krj_peg_f20170707"><?php echo $t_jd_krj_peg->f20170707->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170707->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170708->Visible) { // f20170708 ?>
	<tr id="r_f20170708">
		<td><span id="elh_t_jd_krj_peg_f20170708"><?php echo $t_jd_krj_peg->f20170708->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170708->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170709->Visible) { // f20170709 ?>
	<tr id="r_f20170709">
		<td><span id="elh_t_jd_krj_peg_f20170709"><?php echo $t_jd_krj_peg->f20170709->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170709->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170710->Visible) { // f20170710 ?>
	<tr id="r_f20170710">
		<td><span id="elh_t_jd_krj_peg_f20170710"><?php echo $t_jd_krj_peg->f20170710->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170710->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170711->Visible) { // f20170711 ?>
	<tr id="r_f20170711">
		<td><span id="elh_t_jd_krj_peg_f20170711"><?php echo $t_jd_krj_peg->f20170711->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170711->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170712->Visible) { // f20170712 ?>
	<tr id="r_f20170712">
		<td><span id="elh_t_jd_krj_peg_f20170712"><?php echo $t_jd_krj_peg->f20170712->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170712->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170713->Visible) { // f20170713 ?>
	<tr id="r_f20170713">
		<td><span id="elh_t_jd_krj_peg_f20170713"><?php echo $t_jd_krj_peg->f20170713->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170713->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170714->Visible) { // f20170714 ?>
	<tr id="r_f20170714">
		<td><span id="elh_t_jd_krj_peg_f20170714"><?php echo $t_jd_krj_peg->f20170714->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170714->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170715->Visible) { // f20170715 ?>
	<tr id="r_f20170715">
		<td><span id="elh_t_jd_krj_peg_f20170715"><?php echo $t_jd_krj_peg->f20170715->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170715->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170716->Visible) { // f20170716 ?>
	<tr id="r_f20170716">
		<td><span id="elh_t_jd_krj_peg_f20170716"><?php echo $t_jd_krj_peg->f20170716->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170716->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170717->Visible) { // f20170717 ?>
	<tr id="r_f20170717">
		<td><span id="elh_t_jd_krj_peg_f20170717"><?php echo $t_jd_krj_peg->f20170717->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170717->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170718->Visible) { // f20170718 ?>
	<tr id="r_f20170718">
		<td><span id="elh_t_jd_krj_peg_f20170718"><?php echo $t_jd_krj_peg->f20170718->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170718->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170719->Visible) { // f20170719 ?>
	<tr id="r_f20170719">
		<td><span id="elh_t_jd_krj_peg_f20170719"><?php echo $t_jd_krj_peg->f20170719->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170719->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170720->Visible) { // f20170720 ?>
	<tr id="r_f20170720">
		<td><span id="elh_t_jd_krj_peg_f20170720"><?php echo $t_jd_krj_peg->f20170720->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170720->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170721->Visible) { // f20170721 ?>
	<tr id="r_f20170721">
		<td><span id="elh_t_jd_krj_peg_f20170721"><?php echo $t_jd_krj_peg->f20170721->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170721->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170722->Visible) { // f20170722 ?>
	<tr id="r_f20170722">
		<td><span id="elh_t_jd_krj_peg_f20170722"><?php echo $t_jd_krj_peg->f20170722->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170722->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170723->Visible) { // f20170723 ?>
	<tr id="r_f20170723">
		<td><span id="elh_t_jd_krj_peg_f20170723"><?php echo $t_jd_krj_peg->f20170723->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170723->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170724->Visible) { // f20170724 ?>
	<tr id="r_f20170724">
		<td><span id="elh_t_jd_krj_peg_f20170724"><?php echo $t_jd_krj_peg->f20170724->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170724->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170725->Visible) { // f20170725 ?>
	<tr id="r_f20170725">
		<td><span id="elh_t_jd_krj_peg_f20170725"><?php echo $t_jd_krj_peg->f20170725->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170725->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170726->Visible) { // f20170726 ?>
	<tr id="r_f20170726">
		<td><span id="elh_t_jd_krj_peg_f20170726"><?php echo $t_jd_krj_peg->f20170726->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170726->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170727->Visible) { // f20170727 ?>
	<tr id="r_f20170727">
		<td><span id="elh_t_jd_krj_peg_f20170727"><?php echo $t_jd_krj_peg->f20170727->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170727->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170728->Visible) { // f20170728 ?>
	<tr id="r_f20170728">
		<td><span id="elh_t_jd_krj_peg_f20170728"><?php echo $t_jd_krj_peg->f20170728->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170728->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170729->Visible) { // f20170729 ?>
	<tr id="r_f20170729">
		<td><span id="elh_t_jd_krj_peg_f20170729"><?php echo $t_jd_krj_peg->f20170729->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170729->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170730->Visible) { // f20170730 ?>
	<tr id="r_f20170730">
		<td><span id="elh_t_jd_krj_peg_f20170730"><?php echo $t_jd_krj_peg->f20170730->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170730->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170731->Visible) { // f20170731 ?>
	<tr id="r_f20170731">
		<td><span id="elh_t_jd_krj_peg_f20170731"><?php echo $t_jd_krj_peg->f20170731->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170731->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170801->Visible) { // f20170801 ?>
	<tr id="r_f20170801">
		<td><span id="elh_t_jd_krj_peg_f20170801"><?php echo $t_jd_krj_peg->f20170801->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170801->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170802->Visible) { // f20170802 ?>
	<tr id="r_f20170802">
		<td><span id="elh_t_jd_krj_peg_f20170802"><?php echo $t_jd_krj_peg->f20170802->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170802->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170803->Visible) { // f20170803 ?>
	<tr id="r_f20170803">
		<td><span id="elh_t_jd_krj_peg_f20170803"><?php echo $t_jd_krj_peg->f20170803->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170803->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170804->Visible) { // f20170804 ?>
	<tr id="r_f20170804">
		<td><span id="elh_t_jd_krj_peg_f20170804"><?php echo $t_jd_krj_peg->f20170804->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170804->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170805->Visible) { // f20170805 ?>
	<tr id="r_f20170805">
		<td><span id="elh_t_jd_krj_peg_f20170805"><?php echo $t_jd_krj_peg->f20170805->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170805->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170806->Visible) { // f20170806 ?>
	<tr id="r_f20170806">
		<td><span id="elh_t_jd_krj_peg_f20170806"><?php echo $t_jd_krj_peg->f20170806->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170806->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170807->Visible) { // f20170807 ?>
	<tr id="r_f20170807">
		<td><span id="elh_t_jd_krj_peg_f20170807"><?php echo $t_jd_krj_peg->f20170807->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170807->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170808->Visible) { // f20170808 ?>
	<tr id="r_f20170808">
		<td><span id="elh_t_jd_krj_peg_f20170808"><?php echo $t_jd_krj_peg->f20170808->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170808->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170809->Visible) { // f20170809 ?>
	<tr id="r_f20170809">
		<td><span id="elh_t_jd_krj_peg_f20170809"><?php echo $t_jd_krj_peg->f20170809->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170809->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170810->Visible) { // f20170810 ?>
	<tr id="r_f20170810">
		<td><span id="elh_t_jd_krj_peg_f20170810"><?php echo $t_jd_krj_peg->f20170810->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170810->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170811->Visible) { // f20170811 ?>
	<tr id="r_f20170811">
		<td><span id="elh_t_jd_krj_peg_f20170811"><?php echo $t_jd_krj_peg->f20170811->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170811->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170812->Visible) { // f20170812 ?>
	<tr id="r_f20170812">
		<td><span id="elh_t_jd_krj_peg_f20170812"><?php echo $t_jd_krj_peg->f20170812->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170812->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170813->Visible) { // f20170813 ?>
	<tr id="r_f20170813">
		<td><span id="elh_t_jd_krj_peg_f20170813"><?php echo $t_jd_krj_peg->f20170813->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170813->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170814->Visible) { // f20170814 ?>
	<tr id="r_f20170814">
		<td><span id="elh_t_jd_krj_peg_f20170814"><?php echo $t_jd_krj_peg->f20170814->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170814->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170815->Visible) { // f20170815 ?>
	<tr id="r_f20170815">
		<td><span id="elh_t_jd_krj_peg_f20170815"><?php echo $t_jd_krj_peg->f20170815->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170815->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170816->Visible) { // f20170816 ?>
	<tr id="r_f20170816">
		<td><span id="elh_t_jd_krj_peg_f20170816"><?php echo $t_jd_krj_peg->f20170816->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170816->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170817->Visible) { // f20170817 ?>
	<tr id="r_f20170817">
		<td><span id="elh_t_jd_krj_peg_f20170817"><?php echo $t_jd_krj_peg->f20170817->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170817->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170818->Visible) { // f20170818 ?>
	<tr id="r_f20170818">
		<td><span id="elh_t_jd_krj_peg_f20170818"><?php echo $t_jd_krj_peg->f20170818->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170818->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170819->Visible) { // f20170819 ?>
	<tr id="r_f20170819">
		<td><span id="elh_t_jd_krj_peg_f20170819"><?php echo $t_jd_krj_peg->f20170819->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170819->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170820->Visible) { // f20170820 ?>
	<tr id="r_f20170820">
		<td><span id="elh_t_jd_krj_peg_f20170820"><?php echo $t_jd_krj_peg->f20170820->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170820->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170821->Visible) { // f20170821 ?>
	<tr id="r_f20170821">
		<td><span id="elh_t_jd_krj_peg_f20170821"><?php echo $t_jd_krj_peg->f20170821->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170821->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170822->Visible) { // f20170822 ?>
	<tr id="r_f20170822">
		<td><span id="elh_t_jd_krj_peg_f20170822"><?php echo $t_jd_krj_peg->f20170822->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170822->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170823->Visible) { // f20170823 ?>
	<tr id="r_f20170823">
		<td><span id="elh_t_jd_krj_peg_f20170823"><?php echo $t_jd_krj_peg->f20170823->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170823->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170824->Visible) { // f20170824 ?>
	<tr id="r_f20170824">
		<td><span id="elh_t_jd_krj_peg_f20170824"><?php echo $t_jd_krj_peg->f20170824->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170824->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170825->Visible) { // f20170825 ?>
	<tr id="r_f20170825">
		<td><span id="elh_t_jd_krj_peg_f20170825"><?php echo $t_jd_krj_peg->f20170825->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170825->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170826->Visible) { // f20170826 ?>
	<tr id="r_f20170826">
		<td><span id="elh_t_jd_krj_peg_f20170826"><?php echo $t_jd_krj_peg->f20170826->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170826->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170827->Visible) { // f20170827 ?>
	<tr id="r_f20170827">
		<td><span id="elh_t_jd_krj_peg_f20170827"><?php echo $t_jd_krj_peg->f20170827->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170827->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170828->Visible) { // f20170828 ?>
	<tr id="r_f20170828">
		<td><span id="elh_t_jd_krj_peg_f20170828"><?php echo $t_jd_krj_peg->f20170828->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170828->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170829->Visible) { // f20170829 ?>
	<tr id="r_f20170829">
		<td><span id="elh_t_jd_krj_peg_f20170829"><?php echo $t_jd_krj_peg->f20170829->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170829->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170830->Visible) { // f20170830 ?>
	<tr id="r_f20170830">
		<td><span id="elh_t_jd_krj_peg_f20170830"><?php echo $t_jd_krj_peg->f20170830->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170830->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170831->Visible) { // f20170831 ?>
	<tr id="r_f20170831">
		<td><span id="elh_t_jd_krj_peg_f20170831"><?php echo $t_jd_krj_peg->f20170831->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170831->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170901->Visible) { // f20170901 ?>
	<tr id="r_f20170901">
		<td><span id="elh_t_jd_krj_peg_f20170901"><?php echo $t_jd_krj_peg->f20170901->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170901->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170902->Visible) { // f20170902 ?>
	<tr id="r_f20170902">
		<td><span id="elh_t_jd_krj_peg_f20170902"><?php echo $t_jd_krj_peg->f20170902->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170902->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170903->Visible) { // f20170903 ?>
	<tr id="r_f20170903">
		<td><span id="elh_t_jd_krj_peg_f20170903"><?php echo $t_jd_krj_peg->f20170903->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170903->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170904->Visible) { // f20170904 ?>
	<tr id="r_f20170904">
		<td><span id="elh_t_jd_krj_peg_f20170904"><?php echo $t_jd_krj_peg->f20170904->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170904->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170905->Visible) { // f20170905 ?>
	<tr id="r_f20170905">
		<td><span id="elh_t_jd_krj_peg_f20170905"><?php echo $t_jd_krj_peg->f20170905->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170905->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170906->Visible) { // f20170906 ?>
	<tr id="r_f20170906">
		<td><span id="elh_t_jd_krj_peg_f20170906"><?php echo $t_jd_krj_peg->f20170906->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170906->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170907->Visible) { // f20170907 ?>
	<tr id="r_f20170907">
		<td><span id="elh_t_jd_krj_peg_f20170907"><?php echo $t_jd_krj_peg->f20170907->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170907->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170908->Visible) { // f20170908 ?>
	<tr id="r_f20170908">
		<td><span id="elh_t_jd_krj_peg_f20170908"><?php echo $t_jd_krj_peg->f20170908->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170908->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170909->Visible) { // f20170909 ?>
	<tr id="r_f20170909">
		<td><span id="elh_t_jd_krj_peg_f20170909"><?php echo $t_jd_krj_peg->f20170909->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170909->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170910->Visible) { // f20170910 ?>
	<tr id="r_f20170910">
		<td><span id="elh_t_jd_krj_peg_f20170910"><?php echo $t_jd_krj_peg->f20170910->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170910->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170911->Visible) { // f20170911 ?>
	<tr id="r_f20170911">
		<td><span id="elh_t_jd_krj_peg_f20170911"><?php echo $t_jd_krj_peg->f20170911->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170911->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170912->Visible) { // f20170912 ?>
	<tr id="r_f20170912">
		<td><span id="elh_t_jd_krj_peg_f20170912"><?php echo $t_jd_krj_peg->f20170912->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170912->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170913->Visible) { // f20170913 ?>
	<tr id="r_f20170913">
		<td><span id="elh_t_jd_krj_peg_f20170913"><?php echo $t_jd_krj_peg->f20170913->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170913->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170914->Visible) { // f20170914 ?>
	<tr id="r_f20170914">
		<td><span id="elh_t_jd_krj_peg_f20170914"><?php echo $t_jd_krj_peg->f20170914->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170914->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170915->Visible) { // f20170915 ?>
	<tr id="r_f20170915">
		<td><span id="elh_t_jd_krj_peg_f20170915"><?php echo $t_jd_krj_peg->f20170915->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170915->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170916->Visible) { // f20170916 ?>
	<tr id="r_f20170916">
		<td><span id="elh_t_jd_krj_peg_f20170916"><?php echo $t_jd_krj_peg->f20170916->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170916->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170917->Visible) { // f20170917 ?>
	<tr id="r_f20170917">
		<td><span id="elh_t_jd_krj_peg_f20170917"><?php echo $t_jd_krj_peg->f20170917->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170917->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170918->Visible) { // f20170918 ?>
	<tr id="r_f20170918">
		<td><span id="elh_t_jd_krj_peg_f20170918"><?php echo $t_jd_krj_peg->f20170918->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170918->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170919->Visible) { // f20170919 ?>
	<tr id="r_f20170919">
		<td><span id="elh_t_jd_krj_peg_f20170919"><?php echo $t_jd_krj_peg->f20170919->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170919->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170920->Visible) { // f20170920 ?>
	<tr id="r_f20170920">
		<td><span id="elh_t_jd_krj_peg_f20170920"><?php echo $t_jd_krj_peg->f20170920->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170920->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170921->Visible) { // f20170921 ?>
	<tr id="r_f20170921">
		<td><span id="elh_t_jd_krj_peg_f20170921"><?php echo $t_jd_krj_peg->f20170921->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170921->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170922->Visible) { // f20170922 ?>
	<tr id="r_f20170922">
		<td><span id="elh_t_jd_krj_peg_f20170922"><?php echo $t_jd_krj_peg->f20170922->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170922->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170923->Visible) { // f20170923 ?>
	<tr id="r_f20170923">
		<td><span id="elh_t_jd_krj_peg_f20170923"><?php echo $t_jd_krj_peg->f20170923->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170923->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170924->Visible) { // f20170924 ?>
	<tr id="r_f20170924">
		<td><span id="elh_t_jd_krj_peg_f20170924"><?php echo $t_jd_krj_peg->f20170924->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170924->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170925->Visible) { // f20170925 ?>
	<tr id="r_f20170925">
		<td><span id="elh_t_jd_krj_peg_f20170925"><?php echo $t_jd_krj_peg->f20170925->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170925->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170926->Visible) { // f20170926 ?>
	<tr id="r_f20170926">
		<td><span id="elh_t_jd_krj_peg_f20170926"><?php echo $t_jd_krj_peg->f20170926->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170926->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170927->Visible) { // f20170927 ?>
	<tr id="r_f20170927">
		<td><span id="elh_t_jd_krj_peg_f20170927"><?php echo $t_jd_krj_peg->f20170927->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170927->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170928->Visible) { // f20170928 ?>
	<tr id="r_f20170928">
		<td><span id="elh_t_jd_krj_peg_f20170928"><?php echo $t_jd_krj_peg->f20170928->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170928->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170929->Visible) { // f20170929 ?>
	<tr id="r_f20170929">
		<td><span id="elh_t_jd_krj_peg_f20170929"><?php echo $t_jd_krj_peg->f20170929->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170929->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20170930->Visible) { // f20170930 ?>
	<tr id="r_f20170930">
		<td><span id="elh_t_jd_krj_peg_f20170930"><?php echo $t_jd_krj_peg->f20170930->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20170930->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171001->Visible) { // f20171001 ?>
	<tr id="r_f20171001">
		<td><span id="elh_t_jd_krj_peg_f20171001"><?php echo $t_jd_krj_peg->f20171001->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171001->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171002->Visible) { // f20171002 ?>
	<tr id="r_f20171002">
		<td><span id="elh_t_jd_krj_peg_f20171002"><?php echo $t_jd_krj_peg->f20171002->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171002->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171003->Visible) { // f20171003 ?>
	<tr id="r_f20171003">
		<td><span id="elh_t_jd_krj_peg_f20171003"><?php echo $t_jd_krj_peg->f20171003->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171003->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171004->Visible) { // f20171004 ?>
	<tr id="r_f20171004">
		<td><span id="elh_t_jd_krj_peg_f20171004"><?php echo $t_jd_krj_peg->f20171004->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171004->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171005->Visible) { // f20171005 ?>
	<tr id="r_f20171005">
		<td><span id="elh_t_jd_krj_peg_f20171005"><?php echo $t_jd_krj_peg->f20171005->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171005->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171006->Visible) { // f20171006 ?>
	<tr id="r_f20171006">
		<td><span id="elh_t_jd_krj_peg_f20171006"><?php echo $t_jd_krj_peg->f20171006->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171006->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171007->Visible) { // f20171007 ?>
	<tr id="r_f20171007">
		<td><span id="elh_t_jd_krj_peg_f20171007"><?php echo $t_jd_krj_peg->f20171007->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171007->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171008->Visible) { // f20171008 ?>
	<tr id="r_f20171008">
		<td><span id="elh_t_jd_krj_peg_f20171008"><?php echo $t_jd_krj_peg->f20171008->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171008->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171009->Visible) { // f20171009 ?>
	<tr id="r_f20171009">
		<td><span id="elh_t_jd_krj_peg_f20171009"><?php echo $t_jd_krj_peg->f20171009->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171009->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171010->Visible) { // f20171010 ?>
	<tr id="r_f20171010">
		<td><span id="elh_t_jd_krj_peg_f20171010"><?php echo $t_jd_krj_peg->f20171010->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171010->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171011->Visible) { // f20171011 ?>
	<tr id="r_f20171011">
		<td><span id="elh_t_jd_krj_peg_f20171011"><?php echo $t_jd_krj_peg->f20171011->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171011->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171012->Visible) { // f20171012 ?>
	<tr id="r_f20171012">
		<td><span id="elh_t_jd_krj_peg_f20171012"><?php echo $t_jd_krj_peg->f20171012->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171012->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171013->Visible) { // f20171013 ?>
	<tr id="r_f20171013">
		<td><span id="elh_t_jd_krj_peg_f20171013"><?php echo $t_jd_krj_peg->f20171013->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171013->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171014->Visible) { // f20171014 ?>
	<tr id="r_f20171014">
		<td><span id="elh_t_jd_krj_peg_f20171014"><?php echo $t_jd_krj_peg->f20171014->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171014->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171015->Visible) { // f20171015 ?>
	<tr id="r_f20171015">
		<td><span id="elh_t_jd_krj_peg_f20171015"><?php echo $t_jd_krj_peg->f20171015->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171015->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171016->Visible) { // f20171016 ?>
	<tr id="r_f20171016">
		<td><span id="elh_t_jd_krj_peg_f20171016"><?php echo $t_jd_krj_peg->f20171016->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171016->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171017->Visible) { // f20171017 ?>
	<tr id="r_f20171017">
		<td><span id="elh_t_jd_krj_peg_f20171017"><?php echo $t_jd_krj_peg->f20171017->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171017->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171018->Visible) { // f20171018 ?>
	<tr id="r_f20171018">
		<td><span id="elh_t_jd_krj_peg_f20171018"><?php echo $t_jd_krj_peg->f20171018->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171018->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171019->Visible) { // f20171019 ?>
	<tr id="r_f20171019">
		<td><span id="elh_t_jd_krj_peg_f20171019"><?php echo $t_jd_krj_peg->f20171019->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171019->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171020->Visible) { // f20171020 ?>
	<tr id="r_f20171020">
		<td><span id="elh_t_jd_krj_peg_f20171020"><?php echo $t_jd_krj_peg->f20171020->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171020->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171021->Visible) { // f20171021 ?>
	<tr id="r_f20171021">
		<td><span id="elh_t_jd_krj_peg_f20171021"><?php echo $t_jd_krj_peg->f20171021->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171021->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171022->Visible) { // f20171022 ?>
	<tr id="r_f20171022">
		<td><span id="elh_t_jd_krj_peg_f20171022"><?php echo $t_jd_krj_peg->f20171022->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171022->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171023->Visible) { // f20171023 ?>
	<tr id="r_f20171023">
		<td><span id="elh_t_jd_krj_peg_f20171023"><?php echo $t_jd_krj_peg->f20171023->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171023->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171024->Visible) { // f20171024 ?>
	<tr id="r_f20171024">
		<td><span id="elh_t_jd_krj_peg_f20171024"><?php echo $t_jd_krj_peg->f20171024->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171024->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171025->Visible) { // f20171025 ?>
	<tr id="r_f20171025">
		<td><span id="elh_t_jd_krj_peg_f20171025"><?php echo $t_jd_krj_peg->f20171025->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171025->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171026->Visible) { // f20171026 ?>
	<tr id="r_f20171026">
		<td><span id="elh_t_jd_krj_peg_f20171026"><?php echo $t_jd_krj_peg->f20171026->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171026->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171027->Visible) { // f20171027 ?>
	<tr id="r_f20171027">
		<td><span id="elh_t_jd_krj_peg_f20171027"><?php echo $t_jd_krj_peg->f20171027->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171027->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171028->Visible) { // f20171028 ?>
	<tr id="r_f20171028">
		<td><span id="elh_t_jd_krj_peg_f20171028"><?php echo $t_jd_krj_peg->f20171028->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171028->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171029->Visible) { // f20171029 ?>
	<tr id="r_f20171029">
		<td><span id="elh_t_jd_krj_peg_f20171029"><?php echo $t_jd_krj_peg->f20171029->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171029->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171030->Visible) { // f20171030 ?>
	<tr id="r_f20171030">
		<td><span id="elh_t_jd_krj_peg_f20171030"><?php echo $t_jd_krj_peg->f20171030->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171030->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171031->Visible) { // f20171031 ?>
	<tr id="r_f20171031">
		<td><span id="elh_t_jd_krj_peg_f20171031"><?php echo $t_jd_krj_peg->f20171031->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171031->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171101->Visible) { // f20171101 ?>
	<tr id="r_f20171101">
		<td><span id="elh_t_jd_krj_peg_f20171101"><?php echo $t_jd_krj_peg->f20171101->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171101->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171102->Visible) { // f20171102 ?>
	<tr id="r_f20171102">
		<td><span id="elh_t_jd_krj_peg_f20171102"><?php echo $t_jd_krj_peg->f20171102->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171102->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171103->Visible) { // f20171103 ?>
	<tr id="r_f20171103">
		<td><span id="elh_t_jd_krj_peg_f20171103"><?php echo $t_jd_krj_peg->f20171103->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171103->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171104->Visible) { // f20171104 ?>
	<tr id="r_f20171104">
		<td><span id="elh_t_jd_krj_peg_f20171104"><?php echo $t_jd_krj_peg->f20171104->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171104->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171105->Visible) { // f20171105 ?>
	<tr id="r_f20171105">
		<td><span id="elh_t_jd_krj_peg_f20171105"><?php echo $t_jd_krj_peg->f20171105->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171105->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171106->Visible) { // f20171106 ?>
	<tr id="r_f20171106">
		<td><span id="elh_t_jd_krj_peg_f20171106"><?php echo $t_jd_krj_peg->f20171106->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171106->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171107->Visible) { // f20171107 ?>
	<tr id="r_f20171107">
		<td><span id="elh_t_jd_krj_peg_f20171107"><?php echo $t_jd_krj_peg->f20171107->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171107->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171108->Visible) { // f20171108 ?>
	<tr id="r_f20171108">
		<td><span id="elh_t_jd_krj_peg_f20171108"><?php echo $t_jd_krj_peg->f20171108->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171108->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171109->Visible) { // f20171109 ?>
	<tr id="r_f20171109">
		<td><span id="elh_t_jd_krj_peg_f20171109"><?php echo $t_jd_krj_peg->f20171109->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171109->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171110->Visible) { // f20171110 ?>
	<tr id="r_f20171110">
		<td><span id="elh_t_jd_krj_peg_f20171110"><?php echo $t_jd_krj_peg->f20171110->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171110->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171111->Visible) { // f20171111 ?>
	<tr id="r_f20171111">
		<td><span id="elh_t_jd_krj_peg_f20171111"><?php echo $t_jd_krj_peg->f20171111->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171111->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171112->Visible) { // f20171112 ?>
	<tr id="r_f20171112">
		<td><span id="elh_t_jd_krj_peg_f20171112"><?php echo $t_jd_krj_peg->f20171112->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171112->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171113->Visible) { // f20171113 ?>
	<tr id="r_f20171113">
		<td><span id="elh_t_jd_krj_peg_f20171113"><?php echo $t_jd_krj_peg->f20171113->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171113->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171114->Visible) { // f20171114 ?>
	<tr id="r_f20171114">
		<td><span id="elh_t_jd_krj_peg_f20171114"><?php echo $t_jd_krj_peg->f20171114->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171114->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171115->Visible) { // f20171115 ?>
	<tr id="r_f20171115">
		<td><span id="elh_t_jd_krj_peg_f20171115"><?php echo $t_jd_krj_peg->f20171115->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171115->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171116->Visible) { // f20171116 ?>
	<tr id="r_f20171116">
		<td><span id="elh_t_jd_krj_peg_f20171116"><?php echo $t_jd_krj_peg->f20171116->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171116->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171117->Visible) { // f20171117 ?>
	<tr id="r_f20171117">
		<td><span id="elh_t_jd_krj_peg_f20171117"><?php echo $t_jd_krj_peg->f20171117->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171117->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171118->Visible) { // f20171118 ?>
	<tr id="r_f20171118">
		<td><span id="elh_t_jd_krj_peg_f20171118"><?php echo $t_jd_krj_peg->f20171118->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171118->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171119->Visible) { // f20171119 ?>
	<tr id="r_f20171119">
		<td><span id="elh_t_jd_krj_peg_f20171119"><?php echo $t_jd_krj_peg->f20171119->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171119->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171120->Visible) { // f20171120 ?>
	<tr id="r_f20171120">
		<td><span id="elh_t_jd_krj_peg_f20171120"><?php echo $t_jd_krj_peg->f20171120->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171120->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171121->Visible) { // f20171121 ?>
	<tr id="r_f20171121">
		<td><span id="elh_t_jd_krj_peg_f20171121"><?php echo $t_jd_krj_peg->f20171121->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171121->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171122->Visible) { // f20171122 ?>
	<tr id="r_f20171122">
		<td><span id="elh_t_jd_krj_peg_f20171122"><?php echo $t_jd_krj_peg->f20171122->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171122->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171123->Visible) { // f20171123 ?>
	<tr id="r_f20171123">
		<td><span id="elh_t_jd_krj_peg_f20171123"><?php echo $t_jd_krj_peg->f20171123->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171123->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171124->Visible) { // f20171124 ?>
	<tr id="r_f20171124">
		<td><span id="elh_t_jd_krj_peg_f20171124"><?php echo $t_jd_krj_peg->f20171124->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171124->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171125->Visible) { // f20171125 ?>
	<tr id="r_f20171125">
		<td><span id="elh_t_jd_krj_peg_f20171125"><?php echo $t_jd_krj_peg->f20171125->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171125->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171126->Visible) { // f20171126 ?>
	<tr id="r_f20171126">
		<td><span id="elh_t_jd_krj_peg_f20171126"><?php echo $t_jd_krj_peg->f20171126->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171126->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171127->Visible) { // f20171127 ?>
	<tr id="r_f20171127">
		<td><span id="elh_t_jd_krj_peg_f20171127"><?php echo $t_jd_krj_peg->f20171127->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171127->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171128->Visible) { // f20171128 ?>
	<tr id="r_f20171128">
		<td><span id="elh_t_jd_krj_peg_f20171128"><?php echo $t_jd_krj_peg->f20171128->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171128->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171129->Visible) { // f20171129 ?>
	<tr id="r_f20171129">
		<td><span id="elh_t_jd_krj_peg_f20171129"><?php echo $t_jd_krj_peg->f20171129->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171129->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171130->Visible) { // f20171130 ?>
	<tr id="r_f20171130">
		<td><span id="elh_t_jd_krj_peg_f20171130"><?php echo $t_jd_krj_peg->f20171130->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171130->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171201->Visible) { // f20171201 ?>
	<tr id="r_f20171201">
		<td><span id="elh_t_jd_krj_peg_f20171201"><?php echo $t_jd_krj_peg->f20171201->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171201->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171202->Visible) { // f20171202 ?>
	<tr id="r_f20171202">
		<td><span id="elh_t_jd_krj_peg_f20171202"><?php echo $t_jd_krj_peg->f20171202->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171202->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171203->Visible) { // f20171203 ?>
	<tr id="r_f20171203">
		<td><span id="elh_t_jd_krj_peg_f20171203"><?php echo $t_jd_krj_peg->f20171203->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171203->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171204->Visible) { // f20171204 ?>
	<tr id="r_f20171204">
		<td><span id="elh_t_jd_krj_peg_f20171204"><?php echo $t_jd_krj_peg->f20171204->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171204->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171205->Visible) { // f20171205 ?>
	<tr id="r_f20171205">
		<td><span id="elh_t_jd_krj_peg_f20171205"><?php echo $t_jd_krj_peg->f20171205->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171205->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171206->Visible) { // f20171206 ?>
	<tr id="r_f20171206">
		<td><span id="elh_t_jd_krj_peg_f20171206"><?php echo $t_jd_krj_peg->f20171206->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171206->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171207->Visible) { // f20171207 ?>
	<tr id="r_f20171207">
		<td><span id="elh_t_jd_krj_peg_f20171207"><?php echo $t_jd_krj_peg->f20171207->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171207->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171208->Visible) { // f20171208 ?>
	<tr id="r_f20171208">
		<td><span id="elh_t_jd_krj_peg_f20171208"><?php echo $t_jd_krj_peg->f20171208->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171208->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171209->Visible) { // f20171209 ?>
	<tr id="r_f20171209">
		<td><span id="elh_t_jd_krj_peg_f20171209"><?php echo $t_jd_krj_peg->f20171209->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171209->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171210->Visible) { // f20171210 ?>
	<tr id="r_f20171210">
		<td><span id="elh_t_jd_krj_peg_f20171210"><?php echo $t_jd_krj_peg->f20171210->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171210->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171211->Visible) { // f20171211 ?>
	<tr id="r_f20171211">
		<td><span id="elh_t_jd_krj_peg_f20171211"><?php echo $t_jd_krj_peg->f20171211->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171211->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171212->Visible) { // f20171212 ?>
	<tr id="r_f20171212">
		<td><span id="elh_t_jd_krj_peg_f20171212"><?php echo $t_jd_krj_peg->f20171212->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171212->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171213->Visible) { // f20171213 ?>
	<tr id="r_f20171213">
		<td><span id="elh_t_jd_krj_peg_f20171213"><?php echo $t_jd_krj_peg->f20171213->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171213->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171214->Visible) { // f20171214 ?>
	<tr id="r_f20171214">
		<td><span id="elh_t_jd_krj_peg_f20171214"><?php echo $t_jd_krj_peg->f20171214->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171214->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171215->Visible) { // f20171215 ?>
	<tr id="r_f20171215">
		<td><span id="elh_t_jd_krj_peg_f20171215"><?php echo $t_jd_krj_peg->f20171215->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171215->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171216->Visible) { // f20171216 ?>
	<tr id="r_f20171216">
		<td><span id="elh_t_jd_krj_peg_f20171216"><?php echo $t_jd_krj_peg->f20171216->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171216->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171217->Visible) { // f20171217 ?>
	<tr id="r_f20171217">
		<td><span id="elh_t_jd_krj_peg_f20171217"><?php echo $t_jd_krj_peg->f20171217->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171217->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171218->Visible) { // f20171218 ?>
	<tr id="r_f20171218">
		<td><span id="elh_t_jd_krj_peg_f20171218"><?php echo $t_jd_krj_peg->f20171218->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171218->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171219->Visible) { // f20171219 ?>
	<tr id="r_f20171219">
		<td><span id="elh_t_jd_krj_peg_f20171219"><?php echo $t_jd_krj_peg->f20171219->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171219->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171220->Visible) { // f20171220 ?>
	<tr id="r_f20171220">
		<td><span id="elh_t_jd_krj_peg_f20171220"><?php echo $t_jd_krj_peg->f20171220->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171220->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171221->Visible) { // f20171221 ?>
	<tr id="r_f20171221">
		<td><span id="elh_t_jd_krj_peg_f20171221"><?php echo $t_jd_krj_peg->f20171221->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171221->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171222->Visible) { // f20171222 ?>
	<tr id="r_f20171222">
		<td><span id="elh_t_jd_krj_peg_f20171222"><?php echo $t_jd_krj_peg->f20171222->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171222->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171223->Visible) { // f20171223 ?>
	<tr id="r_f20171223">
		<td><span id="elh_t_jd_krj_peg_f20171223"><?php echo $t_jd_krj_peg->f20171223->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171223->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171224->Visible) { // f20171224 ?>
	<tr id="r_f20171224">
		<td><span id="elh_t_jd_krj_peg_f20171224"><?php echo $t_jd_krj_peg->f20171224->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171224->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171225->Visible) { // f20171225 ?>
	<tr id="r_f20171225">
		<td><span id="elh_t_jd_krj_peg_f20171225"><?php echo $t_jd_krj_peg->f20171225->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171225->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171226->Visible) { // f20171226 ?>
	<tr id="r_f20171226">
		<td><span id="elh_t_jd_krj_peg_f20171226"><?php echo $t_jd_krj_peg->f20171226->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171226->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171227->Visible) { // f20171227 ?>
	<tr id="r_f20171227">
		<td><span id="elh_t_jd_krj_peg_f20171227"><?php echo $t_jd_krj_peg->f20171227->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171227->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171228->Visible) { // f20171228 ?>
	<tr id="r_f20171228">
		<td><span id="elh_t_jd_krj_peg_f20171228"><?php echo $t_jd_krj_peg->f20171228->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171228->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171229->Visible) { // f20171229 ?>
	<tr id="r_f20171229">
		<td><span id="elh_t_jd_krj_peg_f20171229"><?php echo $t_jd_krj_peg->f20171229->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171229->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171230->Visible) { // f20171230 ?>
	<tr id="r_f20171230">
		<td><span id="elh_t_jd_krj_peg_f20171230"><?php echo $t_jd_krj_peg->f20171230->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171230->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jd_krj_peg->f20171231->Visible) { // f20171231 ?>
	<tr id="r_f20171231">
		<td><span id="elh_t_jd_krj_peg_f20171231"><?php echo $t_jd_krj_peg->f20171231->FldCaption() ?></span></td>
...
<?php echo $t_jd_krj_peg->f20171231->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($t_jd_krj_peg->Export == "") { ?>
<script type="text/javascript">
ft_jd_krj_pegview.Init();
</script>
<?php } ?>
<?php
$t_jd_krj_peg_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($t_jd_krj_peg->Export == "") { ?>
...
<?php
$t_jd_krj_peg_view->Page_Terminate();
?>
