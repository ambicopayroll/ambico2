...
class ct_jdw_krj_peg extends cTable {
	...
	function __construct() {
		...
		// tgl1
		$this->tgl1 = new cField('t_jdw_krj_peg', 't_jdw_krj_peg', 'x_tgl1', 'tgl1', '`tgl1`', ew_CastDateFieldForLike('`tgl1`', 0, "DB"), 133, -1, FALSE, '`tgl1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl2
		$this->tgl2 = new cField('t_jdw_krj_peg', 't_jdw_krj_peg', 'x_tgl2', 'tgl2', '`tgl2`', ew_CastDateFieldForLike('`tgl2`', 0, "DB"), 133, -1, FALSE, '`tgl2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
