...
$t_jdkr_peg_delete = NULL; // Initialize page object first

class ct_jdkr_peg_delete extends ct_jdkr_peg {
	...
	// Page object name
	var $PageObjName = 't_jdkr_peg_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t_jdkr_peglist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t_jdkr_peg class, t_jdkr_peginfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t_jdkr_peglist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t_jdkr_peg_delete)) $t_jdkr_peg_delete = new ct_jdkr_peg_delete();

// Page init
$t_jdkr_peg_delete->Page_Init();

// Page main
$t_jdkr_peg_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_jdkr_peg_delete->Page_Render();
?>
...
var CurrentForm = ft_jdkr_pegdelete = new ew_Form("ft_jdkr_pegdelete", "delete");

// Form_CustomValidate event
ft_jdkr_pegdelete.Form_CustomValidate = 
...
ft_jdkr_pegdelete.ValidateRequired = true;
<?php } else { ?>
ft_jdkr_pegdelete.ValidateRequired = false; 
<?php } ?>
...
<?php $t_jdkr_peg_delete->ShowPageHeader(); ?>
<?php
$t_jdkr_peg_delete->ShowMessage();
?>
<form name="ft_jdkr_pegdelete" id="ft_jdkr_pegdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_jdkr_peg_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_jdkr_peg_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t_jdkr_peg">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($t_jdkr_peg_delete->RecKeys as $key) { ?>
...
<?php if ($t_jdkr_peg->jdkr_id->Visible) { // jdkr_id ?>
		<th><span id="elh_t_jdkr_peg_jdkr_id" class="t_jdkr_peg_jdkr_id"><?php echo $t_jdkr_peg->jdkr_id->FldCaption() ?></span></th>
<?php } ?>
...
<?php } ?>
	...
	<tbody>
<?php
$t_jdkr_peg_delete->RecCnt = 0;
$i = 0;
while (!$t_jdkr_peg_delete->Recordset->EOF) {
	$t_jdkr_peg_delete->RecCnt++;
	$t_jdkr_peg_delete->RowCnt++;

	// Set row properties
	$t_jdkr_peg->ResetAttrs();
	$t_jdkr_peg->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$t_jdkr_peg_delete->LoadRowValues($t_jdkr_peg_delete->Recordset);

	// Render row
	$t_jdkr_peg_delete->RenderRow();
?>
	<tr<?php echo $t_jdkr_peg->RowAttributes() ?>>
<?php if ($t_jdkr_peg->jdkr_id->Visible) { // jdkr_id ?>
		<td<?php echo $t_jdkr_peg->jdkr_id->CellAttributes() ?>>
<span id="el<?php echo $t_jdkr_peg_delete->RowCnt ?>_t_jdkr_peg_jdkr_id" class="t_jdkr_peg_jdkr_id">
...
<span id="el<?php echo $t_jdkr_peg_delete->RowCnt ?>_t_jdkr_peg_pegawai_id" class="t_jdkr_peg_pegawai_id">
...
<span id="el<?php echo $t_jdkr_peg_delete->RowCnt ?>_t_jdkr_peg_jk_id" class="t_jdkr_peg_jk_id">
...
<?php
	$t_jdkr_peg_delete->Recordset->MoveNext();
}
$t_jdkr_peg_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_jdkr_peg_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft_jdkr_pegdelete.Init();
</script>
<?php
$t_jdkr_peg_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_jdkr_peg_delete->Page_Terminate();
?>
