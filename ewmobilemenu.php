...
$RootMenu->AddMenuItem(10070, "mmri_r5frekon", $Language->MenuPhrase("10070", "MenuText"), "r_rekonctb.php", 129, "{39A6CE71-835C-4F14-B0BC-8FD07F3D6A26}", AllowListMenu('{39A6CE71-835C-4F14-B0BC-8FD07F3D6A26}r_rekon'), FALSE, FALSE);
...
$RootMenu->AddMenuItem(10080, "mmi_rekon__php", $Language->MenuPhrase("10080", "MenuText"), "rekon_.php", 128, "", AllowListMenu('{4B5DAB39-E4BC-48DF-9311-E295A5F18030}rekon_.php'), FALSE, TRUE);
