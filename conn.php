...
if ($_SERVER["HTTP_POST"] == "localhost" ) {
	...
	$password_conn = "admin";
} elseif ($_SERVER["HTTP_POST"] == "ambico.nma-indonesia.com") { // setting koneksi database untuk komputer server
...
} elseif ($_SERVER["HTTP_POST"] == "ambico2.890m.com") { // setting koneksi database untuk komputer server
	$hostname_conn = "mysql.idhostinger.com";  // sesuaikan dengan ip address atau hostname komputer server
