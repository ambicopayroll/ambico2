...
define("EWR_PROJECT_ID", "{39A6CE71-835C-4F14-B0BC-8FD07F3D6A26}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "ambico2", TRUE); // Project Name
...
define("EWR_RANDOM_KEY", '4ikGrC4OCi0WwA7n', TRUE); // Random key for encryption
define("EWR_PROJECT_STYLESHEET_FILENAME", "phprptcss/ambico2.css", TRUE); // Project stylesheet file name
...
define("EWR_TABLE_PREFIX", "{39A6CE71-835C-4F14-B0BC-8FD07F3D6A26}", TRUE);
