...
$rekon_master_add = NULL; // Initialize page object first

class crekon_master_add extends crekon_master {
	...
	// Page object name
	var $PageObjName = 'rekon_master_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["rm_id"] != "") {
				...
				$this->setKey("rm_id", $this->rm_id->CurrentValue); // Set up key
			} else {
				$this->setKey("rm_id", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "rekon_masterview.php")
	...
	function LoadDefaultValues() {
		...
		$this->f1->CurrentValue = NULL;
		$this->f1->OldValue = $this->f1->CurrentValue;
		$this->f2->CurrentValue = NULL;
		$this->f2->OldValue = $this->f2->CurrentValue;
		$this->f3->CurrentValue = NULL;
		$this->f3->OldValue = $this->f3->CurrentValue;
		$this->f4->CurrentValue = NULL;
		$this->f4->OldValue = $this->f4->CurrentValue;
		$this->f5->CurrentValue = NULL;
		$this->f5->OldValue = $this->f5->CurrentValue;
		$this->f6->CurrentValue = NULL;
		$this->f6->OldValue = $this->f6->CurrentValue;
		$this->f7->CurrentValue = NULL;
		$this->f7->OldValue = $this->f7->CurrentValue;
		$this->f8->CurrentValue = NULL;
		$this->f8->OldValue = $this->f8->CurrentValue;
		$this->f9->CurrentValue = NULL;
		$this->f9->OldValue = $this->f9->CurrentValue;
		$this->f10->CurrentValue = NULL;
		$this->f10->OldValue = $this->f10->CurrentValue;
		$this->f11->CurrentValue = NULL;
		$this->f11->OldValue = $this->f11->CurrentValue;
		$this->f12->CurrentValue = NULL;
		$this->f12->OldValue = $this->f12->CurrentValue;
		$this->f13->CurrentValue = NULL;
		$this->f13->OldValue = $this->f13->CurrentValue;
		$this->f14->CurrentValue = NULL;
		$this->f14->OldValue = $this->f14->CurrentValue;
		$this->f15->CurrentValue = NULL;
		$this->f15->OldValue = $this->f15->CurrentValue;
		$this->f16->CurrentValue = NULL;
		$this->f16->OldValue = $this->f16->CurrentValue;
		$this->f17->CurrentValue = NULL;
		$this->f17->OldValue = $this->f17->CurrentValue;
		$this->f18->CurrentValue = NULL;
		$this->f18->OldValue = $this->f18->CurrentValue;
		$this->f19->CurrentValue = NULL;
		$this->f19->OldValue = $this->f19->CurrentValue;
		$this->f20->CurrentValue = NULL;
		$this->f20->OldValue = $this->f20->CurrentValue;
		$this->f21->CurrentValue = NULL;
		$this->f21->OldValue = $this->f21->CurrentValue;
		$this->f22->CurrentValue = NULL;
		$this->f22->OldValue = $this->f22->CurrentValue;
		$this->f23->CurrentValue = NULL;
		$this->f23->OldValue = $this->f23->CurrentValue;
		$this->f24->CurrentValue = NULL;
		$this->f24->OldValue = $this->f24->CurrentValue;
		$this->f25->CurrentValue = NULL;
		$this->f25->OldValue = $this->f25->CurrentValue;
		$this->f26->CurrentValue = NULL;
		$this->f26->OldValue = $this->f26->CurrentValue;
		$this->f27->CurrentValue = NULL;
		$this->f27->OldValue = $this->f27->CurrentValue;
		$this->f28->CurrentValue = NULL;
		$this->f28->OldValue = $this->f28->CurrentValue;
		$this->f29->CurrentValue = NULL;
		$this->f29->OldValue = $this->f29->CurrentValue;
		$this->f30->CurrentValue = NULL;
		$this->f30->OldValue = $this->f30->CurrentValue;
		$this->f31->CurrentValue = NULL;
		$this->f31->OldValue = $this->f31->CurrentValue;
		$this->f32->CurrentValue = NULL;
		$this->f32->OldValue = $this->f32->CurrentValue;
		$this->f33->CurrentValue = NULL;
		$this->f33->OldValue = $this->f33->CurrentValue;
		$this->f34->CurrentValue = NULL;
		$this->f34->OldValue = $this->f34->CurrentValue;
		$this->f35->CurrentValue = NULL;
		$this->f35->OldValue = $this->f35->CurrentValue;
		$this->f36->CurrentValue = NULL;
		$this->f36->OldValue = $this->f36->CurrentValue;
		$this->f37->CurrentValue = NULL;
		$this->f37->OldValue = $this->f37->CurrentValue;
		$this->f38->CurrentValue = NULL;
		$this->f38->OldValue = $this->f38->CurrentValue;
		$this->f39->CurrentValue = NULL;
		$this->f39->OldValue = $this->f39->CurrentValue;
		$this->f40->CurrentValue = NULL;
		$this->f40->OldValue = $this->f40->CurrentValue;
		$this->f41->CurrentValue = NULL;
		$this->f41->OldValue = $this->f41->CurrentValue;
		$this->f42->CurrentValue = NULL;
		$this->f42->OldValue = $this->f42->CurrentValue;
		$this->f43->CurrentValue = NULL;
		$this->f43->OldValue = $this->f43->CurrentValue;
		$this->f44->CurrentValue = NULL;
		$this->f44->OldValue = $this->f44->CurrentValue;
		$this->f45->CurrentValue = NULL;
		$this->f45->OldValue = $this->f45->CurrentValue;
		$this->f46->CurrentValue = NULL;
		$this->f46->OldValue = $this->f46->CurrentValue;
		$this->f47->CurrentValue = NULL;
		$this->f47->OldValue = $this->f47->CurrentValue;
		$this->f48->CurrentValue = NULL;
		$this->f48->OldValue = $this->f48->CurrentValue;
		$this->f49->CurrentValue = NULL;
		$this->f49->OldValue = $this->f49->CurrentValue;
		$this->f50->CurrentValue = NULL;
		$this->f50->OldValue = $this->f50->CurrentValue;
		$this->f51->CurrentValue = NULL;
		$this->f51->OldValue = $this->f51->CurrentValue;
		$this->f52->CurrentValue = NULL;
		$this->f52->OldValue = $this->f52->CurrentValue;
		$this->f53->CurrentValue = NULL;
		$this->f53->OldValue = $this->f53->CurrentValue;
		$this->f54->CurrentValue = NULL;
		$this->f54->OldValue = $this->f54->CurrentValue;
		$this->f55->CurrentValue = NULL;
		$this->f55->OldValue = $this->f55->CurrentValue;
		$this->f56->CurrentValue = NULL;
		$this->f56->OldValue = $this->f56->CurrentValue;
		$this->f57->CurrentValue = NULL;
		$this->f57->OldValue = $this->f57->CurrentValue;
		$this->f58->CurrentValue = NULL;
		$this->f58->OldValue = $this->f58->CurrentValue;
		$this->f59->CurrentValue = NULL;
		$this->f59->OldValue = $this->f59->CurrentValue;
		$this->f60->CurrentValue = NULL;
		$this->f60->OldValue = $this->f60->CurrentValue;
		$this->f61->CurrentValue = NULL;
		$this->f61->OldValue = $this->f61->CurrentValue;
		$this->f62->CurrentValue = NULL;
		$this->f62->OldValue = $this->f62->CurrentValue;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// f1
		$this->f1->SetDbValueDef($rsnew, $this->f1->CurrentValue, ew_CurrentDate(), FALSE);

		// f2
		$this->f2->SetDbValueDef($rsnew, $this->f2->CurrentValue, ew_CurrentDate(), FALSE);

		// f3
		$this->f3->SetDbValueDef($rsnew, $this->f3->CurrentValue, ew_CurrentDate(), FALSE);

		// f4
		$this->f4->SetDbValueDef($rsnew, $this->f4->CurrentValue, ew_CurrentDate(), FALSE);

		// f5
		$this->f5->SetDbValueDef($rsnew, $this->f5->CurrentValue, ew_CurrentDate(), FALSE);

		// f6
		$this->f6->SetDbValueDef($rsnew, $this->f6->CurrentValue, ew_CurrentDate(), FALSE);

		// f7
		$this->f7->SetDbValueDef($rsnew, $this->f7->CurrentValue, ew_CurrentDate(), FALSE);

		// f8
		$this->f8->SetDbValueDef($rsnew, $this->f8->CurrentValue, ew_CurrentDate(), FALSE);

		// f9
		$this->f9->SetDbValueDef($rsnew, $this->f9->CurrentValue, ew_CurrentDate(), FALSE);

		// f10
		$this->f10->SetDbValueDef($rsnew, $this->f10->CurrentValue, ew_CurrentDate(), FALSE);

		// f11
		$this->f11->SetDbValueDef($rsnew, $this->f11->CurrentValue, ew_CurrentDate(), FALSE);

		// f12
		$this->f12->SetDbValueDef($rsnew, $this->f12->CurrentValue, ew_CurrentDate(), FALSE);

		// f13
		$this->f13->SetDbValueDef($rsnew, $this->f13->CurrentValue, ew_CurrentDate(), FALSE);

		// f14
		$this->f14->SetDbValueDef($rsnew, $this->f14->CurrentValue, ew_CurrentDate(), FALSE);

		// f15
		$this->f15->SetDbValueDef($rsnew, $this->f15->CurrentValue, ew_CurrentDate(), FALSE);

		// f16
		$this->f16->SetDbValueDef($rsnew, $this->f16->CurrentValue, ew_CurrentDate(), FALSE);

		// f17
		$this->f17->SetDbValueDef($rsnew, $this->f17->CurrentValue, ew_CurrentDate(), FALSE);

		// f18
		$this->f18->SetDbValueDef($rsnew, $this->f18->CurrentValue, ew_CurrentDate(), FALSE);

		// f19
		$this->f19->SetDbValueDef($rsnew, $this->f19->CurrentValue, ew_CurrentDate(), FALSE);

		// f20
		$this->f20->SetDbValueDef($rsnew, $this->f20->CurrentValue, ew_CurrentDate(), FALSE);

		// f21
		$this->f21->SetDbValueDef($rsnew, $this->f21->CurrentValue, ew_CurrentDate(), FALSE);

		// f22
		$this->f22->SetDbValueDef($rsnew, $this->f22->CurrentValue, ew_CurrentDate(), FALSE);

		// f23
		$this->f23->SetDbValueDef($rsnew, $this->f23->CurrentValue, ew_CurrentDate(), FALSE);

		// f24
		$this->f24->SetDbValueDef($rsnew, $this->f24->CurrentValue, ew_CurrentDate(), FALSE);

		// f25
		$this->f25->SetDbValueDef($rsnew, $this->f25->CurrentValue, ew_CurrentDate(), FALSE);

		// f26
		$this->f26->SetDbValueDef($rsnew, $this->f26->CurrentValue, ew_CurrentDate(), FALSE);

		// f27
		$this->f27->SetDbValueDef($rsnew, $this->f27->CurrentValue, ew_CurrentDate(), FALSE);

		// f28
		$this->f28->SetDbValueDef($rsnew, $this->f28->CurrentValue, ew_CurrentDate(), FALSE);

		// f29
		$this->f29->SetDbValueDef($rsnew, $this->f29->CurrentValue, ew_CurrentDate(), FALSE);

		// f30
		$this->f30->SetDbValueDef($rsnew, $this->f30->CurrentValue, ew_CurrentDate(), FALSE);

		// f31
		$this->f31->SetDbValueDef($rsnew, $this->f31->CurrentValue, ew_CurrentDate(), FALSE);

		// f32
		$this->f32->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f32->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f33
		$this->f33->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f33->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f34
		$this->f34->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f34->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f35
		$this->f35->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f35->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f36
		$this->f36->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f36->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f37
		$this->f37->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f37->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f38
		$this->f38->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f38->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f39
		$this->f39->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f39->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f40
		$this->f40->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f40->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f41
		$this->f41->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f41->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f42
		$this->f42->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f42->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f43
		$this->f43->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f43->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f44
		$this->f44->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f44->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f45
		$this->f45->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f45->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f46
		$this->f46->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f46->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f47
		$this->f47->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f47->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f48
		$this->f48->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f48->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f49
		$this->f49->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f49->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f50
		$this->f50->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f50->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f51
		$this->f51->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f51->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f52
		$this->f52->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f52->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f53
		$this->f53->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f53->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f54
		$this->f54->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f54->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f55
		$this->f55->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f55->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f56
		$this->f56->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f56->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f57
		$this->f57->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f57->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f58
		$this->f58->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f58->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f59
		$this->f59->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f59->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f60
		$this->f60->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f60->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f61
		$this->f61->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f61->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// f62
		$this->f62->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->f62->CurrentValue, 0), ew_CurrentDate(), FALSE);
...
// Create page object
if (!isset($rekon_master_add)) $rekon_master_add = new crekon_master_add();

// Page init
$rekon_master_add->Page_Init();

// Page main
$rekon_master_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$rekon_master_add->Page_Render();
?>
...
var CurrentForm = frekon_masteradd = new ew_Form("frekon_masteradd", "add");

// Validate form
frekon_masteradd.Validate = function() {
...
frekon_masteradd.Form_CustomValidate = 
...
frekon_masteradd.ValidateRequired = true;
<?php } else { ?>
frekon_masteradd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$rekon_master_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $rekon_master_add->ShowPageHeader(); ?>
<?php
$rekon_master_add->ShowMessage();
?>
<form name="frekon_masteradd" id="frekon_masteradd" class="<?php echo $rekon_master_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($rekon_master_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $rekon_master_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $rekon_master_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
frekon_masteradd.Init();
</script>
<?php
$rekon_master_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$rekon_master_add->Page_Terminate();
?>
