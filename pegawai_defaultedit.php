...
$pegawai_default_edit = NULL; // Initialize page object first

class cpegawai_default_edit extends cpegawai_default {
	...
	// Page object name
	var $PageObjName = 'pegawai_default_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->pd_id->CurrentValue == "") {
			$this->Page_Terminate("pegawai_defaultlist.php"); // Invalid key, return to list
		}
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->pd_id->FldIsDetailKey)
			$this->pd_id->setFormValue($objForm->GetValue("x_pd_id"));
	...
	function RestoreFormValues() {
		global $objForm;
		$this->LoadRow();
		$this->pd_id->CurrentValue = $this->pd_id->FormValue;
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// f0m1
			$this->f0m1->SetDbValueDef($rsnew, $this->f0m1->CurrentValue, "", $this->f0m1->ReadOnly);

			// f0k1
			$this->f0k1->SetDbValueDef($rsnew, $this->f0k1->CurrentValue, "", $this->f0k1->ReadOnly);

			// f1m1
			$this->f1m1->SetDbValueDef($rsnew, $this->f1m1->CurrentValue, "", $this->f1m1->ReadOnly);

			// f1k1
			$this->f1k1->SetDbValueDef($rsnew, $this->f1k1->CurrentValue, "", $this->f1k1->ReadOnly);

			// f2m1
			$this->f2m1->SetDbValueDef($rsnew, $this->f2m1->CurrentValue, "", $this->f2m1->ReadOnly);

			// f2k1
			$this->f2k1->SetDbValueDef($rsnew, $this->f2k1->CurrentValue, "", $this->f2k1->ReadOnly);

			// f3m1
			$this->f3m1->SetDbValueDef($rsnew, $this->f3m1->CurrentValue, "", $this->f3m1->ReadOnly);

			// f3k1
			$this->f3k1->SetDbValueDef($rsnew, $this->f3k1->CurrentValue, "", $this->f3k1->ReadOnly);

			// f4m1
			$this->f4m1->SetDbValueDef($rsnew, $this->f4m1->CurrentValue, "", $this->f4m1->ReadOnly);

			// f4k1
			$this->f4k1->SetDbValueDef($rsnew, $this->f4k1->CurrentValue, "", $this->f4k1->ReadOnly);

			// f5m1
			$this->f5m1->SetDbValueDef($rsnew, $this->f5m1->CurrentValue, "", $this->f5m1->ReadOnly);

			// f5k1
			$this->f5k1->SetDbValueDef($rsnew, $this->f5k1->CurrentValue, "", $this->f5k1->ReadOnly);

			// f6m1
			$this->f6m1->SetDbValueDef($rsnew, $this->f6m1->CurrentValue, "", $this->f6m1->ReadOnly);

			// f6k1
			$this->f6k1->SetDbValueDef($rsnew, $this->f6k1->CurrentValue, "", $this->f6k1->ReadOnly);

			// f0m2
			$this->f0m2->SetDbValueDef($rsnew, $this->f0m2->CurrentValue, "", $this->f0m2->ReadOnly);

			// f0k2
			$this->f0k2->SetDbValueDef($rsnew, $this->f0k2->CurrentValue, "", $this->f0k2->ReadOnly);

			// f1m2
			$this->f1m2->SetDbValueDef($rsnew, $this->f1m2->CurrentValue, "", $this->f1m2->ReadOnly);

			// f1k2
			$this->f1k2->SetDbValueDef($rsnew, $this->f1k2->CurrentValue, "", $this->f1k2->ReadOnly);

			// f2m2
			$this->f2m2->SetDbValueDef($rsnew, $this->f2m2->CurrentValue, "", $this->f2m2->ReadOnly);

			// f2k2
			$this->f2k2->SetDbValueDef($rsnew, $this->f2k2->CurrentValue, "", $this->f2k2->ReadOnly);

			// f3m2
			$this->f3m2->SetDbValueDef($rsnew, $this->f3m2->CurrentValue, "", $this->f3m2->ReadOnly);

			// f3k2
			$this->f3k2->SetDbValueDef($rsnew, $this->f3k2->CurrentValue, "", $this->f3k2->ReadOnly);

			// f4m2
			$this->f4m2->SetDbValueDef($rsnew, $this->f4m2->CurrentValue, "", $this->f4m2->ReadOnly);

			// f4k2
			$this->f4k2->SetDbValueDef($rsnew, $this->f4k2->CurrentValue, "", $this->f4k2->ReadOnly);

			// f5m2
			$this->f5m2->SetDbValueDef($rsnew, $this->f5m2->CurrentValue, "", $this->f5m2->ReadOnly);

			// f5k2
			$this->f5k2->SetDbValueDef($rsnew, $this->f5k2->CurrentValue, "", $this->f5k2->ReadOnly);

			// f6m2
			$this->f6m2->SetDbValueDef($rsnew, $this->f6m2->CurrentValue, "", $this->f6m2->ReadOnly);

			// f6k2
			$this->f6k2->SetDbValueDef($rsnew, $this->f6k2->CurrentValue, "", $this->f6k2->ReadOnly);

			// f0m3
			$this->f0m3->SetDbValueDef($rsnew, $this->f0m3->CurrentValue, "", $this->f0m3->ReadOnly);

			// f0k3
			$this->f0k3->SetDbValueDef($rsnew, $this->f0k3->CurrentValue, "", $this->f0k3->ReadOnly);

			// f1m3
			$this->f1m3->SetDbValueDef($rsnew, $this->f1m3->CurrentValue, "", $this->f1m3->ReadOnly);

			// f1k3
			$this->f1k3->SetDbValueDef($rsnew, $this->f1k3->CurrentValue, "", $this->f1k3->ReadOnly);

			// f2m3
			$this->f2m3->SetDbValueDef($rsnew, $this->f2m3->CurrentValue, "", $this->f2m3->ReadOnly);

			// f2k3
			$this->f2k3->SetDbValueDef($rsnew, $this->f2k3->CurrentValue, "", $this->f2k3->ReadOnly);

			// f3m3
			$this->f3m3->SetDbValueDef($rsnew, $this->f3m3->CurrentValue, "", $this->f3m3->ReadOnly);

			// f3k3
			$this->f3k3->SetDbValueDef($rsnew, $this->f3k3->CurrentValue, "", $this->f3k3->ReadOnly);

			// f4m3
			$this->f4m3->SetDbValueDef($rsnew, $this->f4m3->CurrentValue, "", $this->f4m3->ReadOnly);

			// f4k3
			$this->f4k3->SetDbValueDef($rsnew, $this->f4k3->CurrentValue, "", $this->f4k3->ReadOnly);

			// f5m3
			$this->f5m3->SetDbValueDef($rsnew, $this->f5m3->CurrentValue, "", $this->f5m3->ReadOnly);

			// f5k3
			$this->f5k3->SetDbValueDef($rsnew, $this->f5k3->CurrentValue, "", $this->f5k3->ReadOnly);

			// f6m3
			$this->f6m3->SetDbValueDef($rsnew, $this->f6m3->CurrentValue, "", $this->f6m3->ReadOnly);

			// f6k3
			$this->f6k3->SetDbValueDef($rsnew, $this->f6k3->CurrentValue, "", $this->f6k3->ReadOnly);
...
// Create page object
if (!isset($pegawai_default_edit)) $pegawai_default_edit = new cpegawai_default_edit();

// Page init
$pegawai_default_edit->Page_Init();

// Page main
$pegawai_default_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$pegawai_default_edit->Page_Render();
?>
...
var CurrentForm = fpegawai_defaultedit = new ew_Form("fpegawai_defaultedit", "edit");

// Validate form
fpegawai_defaultedit.Validate = function() {
...
fpegawai_defaultedit.Form_CustomValidate = 
...
fpegawai_defaultedit.ValidateRequired = true;
<?php } else { ?>
fpegawai_defaultedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fpegawai_defaultedit.Lists["x_pegawai_id"] = {"LinkField":"x_pegawai_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_pegawai_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"pegawai"};
fpegawai_defaultedit.Lists["x_dept_id"] = {"LinkField":"x_pembagian2_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_pembagian2_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"pembagian2"};
...
<?php if (!$pegawai_default_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $pegawai_default_edit->ShowPageHeader(); ?>
<?php
$pegawai_default_edit->ShowMessage();
?>
<form name="fpegawai_defaultedit" id="fpegawai_defaultedit" class="<?php echo $pegawai_default_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($pegawai_default_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $pegawai_default_edit->Token ?>">
<?php } ?>
...
<?php if ($pegawai_default->pd_id->Visible) { // pd_id ?>
	<div id="r_pd_id" class="form-group">
		<label id="elh_pegawai_default_pd_id" class="col-sm-2 control-label ewLabel"><?php echo $pegawai_default->pd_id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $pegawai_default->pd_id->CellAttributes() ?>>
<span id="el_pegawai_default_pd_id">
<span<?php echo $pegawai_default->pd_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $pegawai_default->pd_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="pegawai_default" data-field="x_pd_id" name="x_pd_id" id="x_pd_id" value="<?php echo ew_HtmlEncode($pegawai_default->pd_id->CurrentValue) ?>">
<?php echo $pegawai_default->pd_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<script type="text/javascript">
fpegawai_defaultedit.CreateAutoSuggest({"id":"x_pegawai_id","forceSelect":true});
</script>
...
<script type="text/javascript">
fpegawai_defaultedit.CreateAutoSuggest({"id":"x_dept_id","forceSelect":true});
</script>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $pegawai_default_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fpegawai_defaultedit.Init();
</script>
<?php
$pegawai_default_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$pegawai_default_edit->Page_Terminate();
?>
