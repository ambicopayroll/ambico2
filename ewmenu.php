...
$RootMenu->AddMenuItem(10063, "mri_r5frekon", $Language->MenuPhrase("10063", "MenuText"), "r_rekonctb.php", 129, "{39A6CE71-835C-4F14-B0BC-8FD07F3D6A26}", AllowListMenu('{39A6CE71-835C-4F14-B0BC-8FD07F3D6A26}r_rekon'), FALSE, FALSE);
$RootMenu->AddMenuItem(10065, "mri_r5frekon2", $Language->MenuPhrase("10065", "MenuText"), "r_rekon2ctb.php", 129, "{39A6CE71-835C-4F14-B0BC-8FD07F3D6A26}", AllowListMenu('{39A6CE71-835C-4F14-B0BC-8FD07F3D6A26}r_rekon2'), FALSE, FALSE);
