...
$kartu_scanlog_view = NULL; // Initialize page object first

class ckartu_scanlog_view extends ckartu_scanlog {
	...
	// Page object name
	var $PageObjName = 'kartu_scanlog_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["ks_id"] <> "") {
			$this->RecKey["ks_id"] = $_GET["ks_id"];
			$KeyUrl .= "&amp;ks_id=" . urlencode($this->RecKey["ks_id"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["ks_id"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["ks_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["ks_id"] <> "") {
				...
				$this->RecKey["ks_id"] = $this->ks_id->QueryStringValue;
			} elseif (@$_POST["ks_id"] <> "") {
				$this->ks_id->setFormValue($_POST["ks_id"]);
				$this->RecKey["ks_id"] = $this->ks_id->FormValue;
			} else {
				$sReturnUrl = "kartu_scanloglist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "kartu_scanloglist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "kartu_scanloglist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($kartu_scanlog_view)) $kartu_scanlog_view = new ckartu_scanlog_view();

// Page init
$kartu_scanlog_view->Page_Init();

// Page main
$kartu_scanlog_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$kartu_scanlog_view->Page_Render();
?>
...
var CurrentForm = fkartu_scanlogview = new ew_Form("fkartu_scanlogview", "view");

// Form_CustomValidate event
fkartu_scanlogview.Form_CustomValidate = 
...
fkartu_scanlogview.ValidateRequired = true;
<?php } else { ?>
fkartu_scanlogview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($kartu_scanlog->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$kartu_scanlog_view->IsModal) { ?>
<?php if ($kartu_scanlog->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $kartu_scanlog_view->ExportOptions->Render("body") ?>
<?php
	foreach ($kartu_scanlog_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$kartu_scanlog_view->IsModal) { ?>
<?php if ($kartu_scanlog->Export == "") { ?>
...
<?php } ?>
<?php $kartu_scanlog_view->ShowPageHeader(); ?>
<?php
$kartu_scanlog_view->ShowMessage();
?>
<form name="fkartu_scanlogview" id="fkartu_scanlogview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($kartu_scanlog_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $kartu_scanlog_view->Token ?>">
<?php } ?>
...
<?php if ($kartu_scanlog->ks_id->Visible) { // ks_id ?>
	<tr id="r_ks_id">
		<td><span id="elh_kartu_scanlog_ks_id"><?php echo $kartu_scanlog->ks_id->FldCaption() ?></span></td>
...
<?php echo $kartu_scanlog->ks_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kartu_scanlog->pegawai_id->Visible) { // pegawai_id ?>
	<tr id="r_pegawai_id">
		<td><span id="elh_kartu_scanlog_pegawai_id"><?php echo $kartu_scanlog->pegawai_id->FldCaption() ?></span></td>
...
<?php echo $kartu_scanlog->pegawai_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kartu_scanlog->dow->Visible) { // dow ?>
	<tr id="r_dow">
		<td><span id="elh_kartu_scanlog_dow"><?php echo $kartu_scanlog->dow->FldCaption() ?></span></td>
...
<?php echo $kartu_scanlog->dow->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kartu_scanlog->scan_tgl->Visible) { // scan_tgl ?>
	<tr id="r_scan_tgl">
		<td><span id="elh_kartu_scanlog_scan_tgl"><?php echo $kartu_scanlog->scan_tgl->FldCaption() ?></span></td>
...
<?php echo $kartu_scanlog->scan_tgl->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kartu_scanlog->scan_jam_1->Visible) { // scan_jam_1 ?>
	<tr id="r_scan_jam_1">
		<td><span id="elh_kartu_scanlog_scan_jam_1"><?php echo $kartu_scanlog->scan_jam_1->FldCaption() ?></span></td>
...
<?php echo $kartu_scanlog->scan_jam_1->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kartu_scanlog->scan_jam_2->Visible) { // scan_jam_2 ?>
	<tr id="r_scan_jam_2">
		<td><span id="elh_kartu_scanlog_scan_jam_2"><?php echo $kartu_scanlog->scan_jam_2->FldCaption() ?></span></td>
...
<?php echo $kartu_scanlog->scan_jam_2->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kartu_scanlog->scan_jam_3->Visible) { // scan_jam_3 ?>
	<tr id="r_scan_jam_3">
		<td><span id="elh_kartu_scanlog_scan_jam_3"><?php echo $kartu_scanlog->scan_jam_3->FldCaption() ?></span></td>
...
<?php echo $kartu_scanlog->scan_jam_3->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kartu_scanlog->scan_jam_4->Visible) { // scan_jam_4 ?>
	<tr id="r_scan_jam_4">
		<td><span id="elh_kartu_scanlog_scan_jam_4"><?php echo $kartu_scanlog->scan_jam_4->FldCaption() ?></span></td>
...
<?php echo $kartu_scanlog->scan_jam_4->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($kartu_scanlog->Export == "") { ?>
<script type="text/javascript">
fkartu_scanlogview.Init();
</script>
<?php } ?>
<?php
$kartu_scanlog_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($kartu_scanlog->Export == "") { ?>
...
<?php
$kartu_scanlog_view->Page_Terminate();
?>
