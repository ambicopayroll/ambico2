...
$rekon__php = NULL; // Initialize page object first
...
class crekon__php {
	...
	// Table name
	var $TableName = 'rekon_.php';

	// Page object name
	var $PageObjName = 'rekon__php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'rekon_.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "rekon__php", $url, "", "rekon__php", TRUE);
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($rekon__php)) $rekon__php = new crekon__php();

// Page init
$rekon__php->Page_Init();

// Page main
$rekon__php->Page_Main();
