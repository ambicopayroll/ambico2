...
class cjdw_kerja_m extends cTable {
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "jdw_kerja_d") {
			$sDetailUrl = $GLOBALS["jdw_kerja_d"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_jdw_kerja_m_id=" . urlencode($this->jdw_kerja_m_id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "jdw_kerja_mlist.php";
		}
		return $sDetailUrl;
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			...
			$url = $this->KeyUrl("jdw_kerja_medit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			...
			$url = $this->KeyUrl("jdw_kerja_madd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
