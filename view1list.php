...
class cview1_list extends cview1 {
	...
	function Page_Init() {
		...
		$this->jdw_kerja_m_kode2->SetVisibility();
	...
	function SetupKeyValues($key) {
		...
		if (count($arrKeyFlds) >= 2) {
			$this->tgl_shift->setFormValue($arrKeyFlds[0]);
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->jdw_kerja_m_kode2->AdvancedSearch->ToJSON(), ","); // Field jdw_kerja_m_kode2
		if ($this->BasicSearch->Keyword <> "") {
	...
	function RestoreFilterList() {
		...
		// Field jdw_kerja_m_kode2
		$this->jdw_kerja_m_kode2->AdvancedSearch->SearchValue = @$filter["x_jdw_kerja_m_kode2"];
		$this->jdw_kerja_m_kode2->AdvancedSearch->SearchOperator = @$filter["z_jdw_kerja_m_kode2"];
		$this->jdw_kerja_m_kode2->AdvancedSearch->SearchCondition = @$filter["v_jdw_kerja_m_kode2"];
		$this->jdw_kerja_m_kode2->AdvancedSearch->SearchValue2 = @$filter["y_jdw_kerja_m_kode2"];
		$this->jdw_kerja_m_kode2->AdvancedSearch->SearchOperator2 = @$filter["w_jdw_kerja_m_kode2"];
		$this->jdw_kerja_m_kode2->AdvancedSearch->Save();
	...
	function BasicSearchSQL($arKeywords, $type) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->jdw_kerja_m_kode2, $arKeywords, $type);
		return $sWhere;
	}
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->jdw_kerja_m_kode2, $bCtrl); // jdw_kerja_m_kode2
	...
	function ResetCmd() {
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				...
				$this->jdw_kerja_m_kode2->setSort("");
			}
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->tgl_shift->CurrentValue . $GLOBALS["EW_COMPOSITE_KEY_SEPARATOR"] . $this->pegawai_id->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event);'>";
	...
	function LoadDbValues(&$rs) {
		...
		$this->jdw_kerja_m_kode2->DbValue = $row['jdw_kerja_m_kode2'];
	}
...
?>
<?php if ($view1->pegawai_nama->Visible) { // pegawai_nama ?>
	<?php if ($view1->SortUrl($view1->pegawai_nama) == "") { ?>
		<th data-name="pegawai_nama"><div id="elh_view1_pegawai_nama" class="view1_pegawai_nama"><div class="ewTableHeaderCaption"><?php echo $view1->pegawai_nama->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="pegawai_nama"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->pegawai_nama) ?>',2);"><div id="elh_view1_pegawai_nama" class="view1_pegawai_nama">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->pegawai_nama->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($view1->pegawai_nama->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->pegawai_nama->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($view1->pegawai_nip->Visible) { // pegawai_nip ?>
	<?php if ($view1->SortUrl($view1->pegawai_nip) == "") { ?>
		<th data-name="pegawai_nip"><div id="elh_view1_pegawai_nip" class="view1_pegawai_nip"><div class="ewTableHeaderCaption"><?php echo $view1->pegawai_nip->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="pegawai_nip"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->pegawai_nip) ?>',2);"><div id="elh_view1_pegawai_nip" class="view1_pegawai_nip">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->pegawai_nip->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($view1->pegawai_nip->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->pegawai_nip->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($view1->jdw_kerja_m_name->Visible) { // jdw_kerja_m_name ?>
	<?php if ($view1->SortUrl($view1->jdw_kerja_m_name) == "") { ?>
		<th data-name="jdw_kerja_m_name"><div id="elh_view1_jdw_kerja_m_name" class="view1_jdw_kerja_m_name"><div class="ewTableHeaderCaption"><?php echo $view1->jdw_kerja_m_name->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="jdw_kerja_m_name"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->jdw_kerja_m_name) ?>',2);"><div id="elh_view1_jdw_kerja_m_name" class="view1_jdw_kerja_m_name">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->jdw_kerja_m_name->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($view1->jdw_kerja_m_name->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->jdw_kerja_m_name->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($view1->jdw_kerja_m_kode->Visible) { // jdw_kerja_m_kode ?>
	<?php if ($view1->SortUrl($view1->jdw_kerja_m_kode) == "") { ?>
		<th data-name="jdw_kerja_m_kode"><div id="elh_view1_jdw_kerja_m_kode" class="view1_jdw_kerja_m_kode"><div class="ewTableHeaderCaption"><?php echo $view1->jdw_kerja_m_kode->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="jdw_kerja_m_kode"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->jdw_kerja_m_kode) ?>',2);"><div id="elh_view1_jdw_kerja_m_kode" class="view1_jdw_kerja_m_kode">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->jdw_kerja_m_kode->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($view1->jdw_kerja_m_kode->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->jdw_kerja_m_kode->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($view1->tgl_shift->Visible) { // tgl_shift ?>
	<?php if ($view1->SortUrl($view1->tgl_shift) == "") { ?>
		<th data-name="tgl_shift"><div id="elh_view1_tgl_shift" class="view1_tgl_shift"><div class="ewTableHeaderCaption"><?php echo $view1->tgl_shift->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="tgl_shift"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->tgl_shift) ?>',2);"><div id="elh_view1_tgl_shift" class="view1_tgl_shift">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->tgl_shift->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($view1->tgl_shift->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->tgl_shift->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($view1->pegawai_id->Visible) { // pegawai_id ?>
	<?php if ($view1->SortUrl($view1->pegawai_id) == "") { ?>
		<th data-name="pegawai_id"><div id="elh_view1_pegawai_id" class="view1_pegawai_id"><div class="ewTableHeaderCaption"><?php echo $view1->pegawai_id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="pegawai_id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->pegawai_id) ?>',2);"><div id="elh_view1_pegawai_id" class="view1_pegawai_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->pegawai_id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($view1->pegawai_id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->pegawai_id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($view1->jdw_kerja_m_kode2->Visible) { // jdw_kerja_m_kode2 ?>
	<?php if ($view1->SortUrl($view1->jdw_kerja_m_kode2) == "") { ?>
		<th data-name="jdw_kerja_m_kode2"><div id="elh_view1_jdw_kerja_m_kode2" class="view1_jdw_kerja_m_kode2"><div class="ewTableHeaderCaption"><?php echo $view1->jdw_kerja_m_kode2->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="jdw_kerja_m_kode2"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->jdw_kerja_m_kode2) ?>',2);"><div id="elh_view1_jdw_kerja_m_kode2" class="view1_jdw_kerja_m_kode2">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->jdw_kerja_m_kode2->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($view1->jdw_kerja_m_kode2->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->jdw_kerja_m_kode2->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($view1->pegawai_nama->Visible) { // pegawai_nama ?>
		<td data-name="pegawai_nama"<?php echo $view1->pegawai_nama->CellAttributes() ?>>
<span id="el<?php echo $view1_list->RowCnt ?>_view1_pegawai_nama" class="view1_pegawai_nama">
<span<?php echo $view1->pegawai_nama->ViewAttributes() ?>>
<?php echo $view1->pegawai_nama->ListViewValue() ?></span>
</span>
<a id="<?php echo $view1_list->PageObjName . "_row_" . $view1_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($view1->pegawai_nip->Visible) { // pegawai_nip ?>
		<td data-name="pegawai_nip"<?php echo $view1->pegawai_nip->CellAttributes() ?>>
<span id="el<?php echo $view1_list->RowCnt ?>_view1_pegawai_nip" class="view1_pegawai_nip">
<span<?php echo $view1->pegawai_nip->ViewAttributes() ?>>
<?php echo $view1->pegawai_nip->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($view1->jdw_kerja_m_name->Visible) { // jdw_kerja_m_name ?>
		<td data-name="jdw_kerja_m_name"<?php echo $view1->jdw_kerja_m_name->CellAttributes() ?>>
<span id="el<?php echo $view1_list->RowCnt ?>_view1_jdw_kerja_m_name" class="view1_jdw_kerja_m_name">
<span<?php echo $view1->jdw_kerja_m_name->ViewAttributes() ?>>
<?php echo $view1->jdw_kerja_m_name->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($view1->jdw_kerja_m_kode->Visible) { // jdw_kerja_m_kode ?>
		<td data-name="jdw_kerja_m_kode"<?php echo $view1->jdw_kerja_m_kode->CellAttributes() ?>>
<span id="el<?php echo $view1_list->RowCnt ?>_view1_jdw_kerja_m_kode" class="view1_jdw_kerja_m_kode">
<span<?php echo $view1->jdw_kerja_m_kode->ViewAttributes() ?>>
<?php echo $view1->jdw_kerja_m_kode->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($view1->tgl_shift->Visible) { // tgl_shift ?>
		<td data-name="tgl_shift"<?php echo $view1->tgl_shift->CellAttributes() ?>>
<span id="el<?php echo $view1_list->RowCnt ?>_view1_tgl_shift" class="view1_tgl_shift">
<span<?php echo $view1->tgl_shift->ViewAttributes() ?>>
<?php echo $view1->tgl_shift->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($view1->pegawai_id->Visible) { // pegawai_id ?>
		<td data-name="pegawai_id"<?php echo $view1->pegawai_id->CellAttributes() ?>>
<span id="el<?php echo $view1_list->RowCnt ?>_view1_pegawai_id" class="view1_pegawai_id">
<span<?php echo $view1->pegawai_id->ViewAttributes() ?>>
<?php echo $view1->pegawai_id->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($view1->jdw_kerja_m_kode2->Visible) { // jdw_kerja_m_kode2 ?>
		<td data-name="jdw_kerja_m_kode2"<?php echo $view1->jdw_kerja_m_kode2->CellAttributes() ?>>
<span id="el<?php echo $view1_list->RowCnt ?>_view1_jdw_kerja_m_kode2" class="view1_jdw_kerja_m_kode2">
<span<?php echo $view1->jdw_kerja_m_kode2->ViewAttributes() ?>>
<?php echo $view1->jdw_kerja_m_kode2->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
